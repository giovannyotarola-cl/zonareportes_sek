...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_detalleFormasPago Then
			ParentPage = CType(Page, AspNetReportMaker4_detalleFormasPago)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_detalleFormasPago.crLanguage(New AspNetReportMaker4_detalleFormasPago.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
