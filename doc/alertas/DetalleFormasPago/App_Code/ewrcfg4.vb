...
'
Public Partial Class AspNetReportMaker4_detalleFormasPago
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "detalleFormasPago" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "Ups2kv%fNR%_VrTA" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/detalleFormasPago.css" ' Project stylesheet file name
