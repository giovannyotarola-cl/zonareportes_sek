...
<script runat="server">
	...
	protected void Page_Load(object sender, System.EventArgs e) {
		if (Page is AspNetReportMaker4_project1) {
			...
			RootMenu = new AspNetReportMaker4_project1.cMenu("RootMenu", true);		
			RootMenu.AddMenuItem(2, ParentPage.ReportLanguage.Phrase("DetailSummaryReportMenuItemPrefix") + ParentPage.ReportLanguage.MenuPhrase("2", "MenuText") + ParentPage.ReportLanguage.Phrase("DetailSummaryReportMenuItemSuffix"), "Alumnos_Tituladossmry.aspx", -1, "", "", true);
		}			
	}
</script>
<!-- Begin Main Menu -->
