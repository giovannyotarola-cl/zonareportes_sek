$(document).ready(function () {
    ...
    $("input[type=radio]").click(function () {
        ...
        if ((isNumeric($("#MainContent_g" + x + "_" + y + "1_nota").val())) && (isNumeric($("#MainContent_g" + x + "_" + y + "2_nota").val())) && (isNumeric($("#MainContent_g" + x + "_" + y + "3_nota").val())) && (isNumeric($("#MainContent_g" + x + "_" + y + "4_nota").val()))) {
            ...
            a4 = parseInt($("#MainContent_g" + x + "_" + y + "4_nota").val());
            $("#MainContent_g" + x + "_" + y + "_nota").val(((a1 + a2 + a3 + a4) / 4).toFixed(2));
        }
