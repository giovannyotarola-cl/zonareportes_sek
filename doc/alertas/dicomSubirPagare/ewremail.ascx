...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_dicomSubirPagare Then
			ParentPage = CType(Page, AspNetReportMaker4_dicomSubirPagare)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_dicomSubirPagare.crLanguage(New AspNetReportMaker4_dicomSubirPagare.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
