...
Public Partial Class AspNetReportMaker4_dicomSubirPagare
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "dicomSubirPagare" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "0VvXvOnC0Zq77#F6" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/dicomSubirPagare.css" ' Project stylesheet file name
