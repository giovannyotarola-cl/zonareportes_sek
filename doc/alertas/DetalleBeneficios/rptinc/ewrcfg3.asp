...
Const EW_REPORT_RANDOM_KEY = "n0vunqVpPa8DyhDB" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "project1" ' Project Name
Const EW_REPORT_PROJECT_VAR = "project1" ' Project Var
