...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_Reincorporaciones Then
			ParentPage = CType(Page, AspNetReportMaker4_Reincorporaciones)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_Reincorporaciones.crLanguage(New AspNetReportMaker4_Reincorporaciones.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
