...
'
Public Partial Class AspNetReportMaker4_Reincorporaciones
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "Reincorporaciones" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "S#drf0P7miJ4TxnO" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/Reincorporaciones.css" ' Project stylesheet file name
