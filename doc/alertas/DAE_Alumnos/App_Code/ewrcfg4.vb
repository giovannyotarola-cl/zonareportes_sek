...
'
Public Partial Class AspNetReportMaker4_DAE_Alumnos
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "DAE_Alumnos" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "4A6&m61zpn%a5FPC" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/DAE_Alumnos.css" ' Project stylesheet file name
