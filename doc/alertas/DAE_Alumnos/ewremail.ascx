...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_DAE_Alumnos Then
			ParentPage = CType(Page, AspNetReportMaker4_DAE_Alumnos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_DAE_Alumnos.crLanguage(New AspNetReportMaker4_DAE_Alumnos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
