...
Public Partial Class AspNetReportMaker4_listadoAlumnos_Chile
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "listadoAlumnos_Chile" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "Vw6FvLs7HNu#4c9B" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/listadoAlumnos_Chile.css" ' Project stylesheet file name
