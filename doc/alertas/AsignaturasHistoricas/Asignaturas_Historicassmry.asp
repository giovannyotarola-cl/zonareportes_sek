...
Const EW_REPORT_TABLE_VAR = "Asignaturas_Historicas"
Const EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE = "Asignaturas_Historicas_grpperpage"
Const EW_REPORT_TABLE_SESSION_START_GROUP = "Asignaturas_Historicas_start"
Const EW_REPORT_TABLE_SESSION_SEARCH = "Asignaturas_Historicas_search"
Const EW_REPORT_TABLE_SESSION_CHILD_USER_ID = "Asignaturas_Historicas_childuserid"
Const EW_REPORT_TABLE_SESSION_ORDER_BY = "Asignaturas_Historicas_orderby"

' Table Level SQL
Const EW_REPORT_TABLE_SQL_FROM = "[Vista_Carreras_Ramos]"
...
Dim af_NUMNOTAS ' Advanced filter for NUMNOTAS
Dim af_ASISTENCIA ' Advanced filter for ASISTENCIA
Dim af_PORCNP ' Advanced filter for PORCNP
Dim af_PORCERT1 ' Advanced filter for PORCERT1
Dim af_PORCERT2 ' Advanced filter for PORCERT2
Dim af_PORCERT3 ' Advanced filter for PORCERT3
Dim af_PORCERT4 ' Advanced filter for PORCERT4
Dim af_PORCERT5 ' Advanced filter for PORCERT5
Dim af_PORCERT6 ' Advanced filter for PORCERT6
Dim af_PORCERT7 ' Advanced filter for PORCERT7
Dim af_PORCERT8 ' Advanced filter for PORCERT8
Dim af_PORCERT9 ' Advanced filter for PORCERT9
Dim af_PORCERT10 ' Advanced filter for PORCERT10
Dim af_TIPO ' Advanced filter for TIPO
Dim af_z22DANUAL_12DSEM ' Advanced filter for 2-ANUAL 1-SEM
%>
...
' Field CODPROF
Dim sv1_CODPROF, sv1d_CODPROF
Dim sv2_CODPROF, sv2d_CODPROF
Dim so1_CODPROF, so1d_CODPROF
Dim so2_CODPROF, so2d_CODPROF
Dim sc_CODPROF, scd_CODPROF
...
Dim x_NUMNOTAS: x_NUMNOTAS = Null
Dim x_ASISTENCIA: x_ASISTENCIA = Null
Dim x_PORCNP: x_PORCNP = Null
Dim x_PORCERT1: x_PORCERT1 = Null
Dim x_PORCERT2: x_PORCERT2 = Null
Dim x_PORCERT3: x_PORCERT3 = Null
Dim x_PORCERT4: x_PORCERT4 = Null
Dim x_PORCERT5: x_PORCERT5 = Null
Dim x_PORCERT6: x_PORCERT6 = Null
Dim x_PORCERT7: x_PORCERT7 = Null
Dim x_PORCERT8: x_PORCERT8 = Null
Dim x_PORCERT9: x_PORCERT9 = Null
Dim x_PORCERT10: x_PORCERT10 = Null
Dim x_TIPO: x_TIPO = Null
Dim x_z22DANUAL_12DSEM: x_z22DANUAL_12DSEM = Null
...
Dim o_NUMNOTAS, t_NUMNOTAS, ft_NUMNOTAS
o_NUMNOTAS = Null: t_NUMNOTAS = Null: ft_NUMNOTAS = 3
Dim rf_NUMNOTAS, rt_NUMNOTAS
...
Dim o_PORCNP, t_PORCNP, ft_PORCNP
o_PORCNP = Null: t_PORCNP = Null: ft_PORCNP = 131
Dim rf_PORCNP, rt_PORCNP
Dim o_PORCERT1, t_PORCERT1, ft_PORCERT1
o_PORCERT1 = Null: t_PORCERT1 = Null: ft_PORCERT1 = 131
Dim rf_PORCERT1, rt_PORCERT1
Dim o_PORCERT2, t_PORCERT2, ft_PORCERT2
o_PORCERT2 = Null: t_PORCERT2 = Null: ft_PORCERT2 = 131
Dim rf_PORCERT2, rt_PORCERT2
Dim o_PORCERT3, t_PORCERT3, ft_PORCERT3
o_PORCERT3 = Null: t_PORCERT3 = Null: ft_PORCERT3 = 131
Dim rf_PORCERT3, rt_PORCERT3
Dim o_PORCERT4, t_PORCERT4, ft_PORCERT4
o_PORCERT4 = Null: t_PORCERT4 = Null: ft_PORCERT4 = 131
Dim rf_PORCERT4, rt_PORCERT4
Dim o_PORCERT5, t_PORCERT5, ft_PORCERT5
o_PORCERT5 = Null: t_PORCERT5 = Null: ft_PORCERT5 = 131
Dim rf_PORCERT5, rt_PORCERT5
Dim o_PORCERT6, t_PORCERT6, ft_PORCERT6
o_PORCERT6 = Null: t_PORCERT6 = Null: ft_PORCERT6 = 131
Dim rf_PORCERT6, rt_PORCERT6
Dim o_PORCERT7, t_PORCERT7, ft_PORCERT7
o_PORCERT7 = Null: t_PORCERT7 = Null: ft_PORCERT7 = 131
Dim rf_PORCERT7, rt_PORCERT7
Dim o_PORCERT8, t_PORCERT8, ft_PORCERT8
o_PORCERT8 = Null: t_PORCERT8 = Null: ft_PORCERT8 = 131
Dim rf_PORCERT8, rt_PORCERT8
Dim o_PORCERT9, t_PORCERT9, ft_PORCERT9
o_PORCERT9 = Null: t_PORCERT9 = Null: ft_PORCERT9 = 131
Dim rf_PORCERT9, rt_PORCERT9
Dim o_PORCERT10, t_PORCERT10, ft_PORCERT10
o_PORCERT10 = Null: t_PORCERT10 = Null: ft_PORCERT10 = 131
Dim rf_PORCERT10, rt_PORCERT10
Dim o_TIPO, t_TIPO, ft_TIPO
o_TIPO = Null: t_TIPO = Null: ft_TIPO = 200
Dim rf_TIPO, rt_TIPO
Dim o_z22DANUAL_12DSEM, t_z22DANUAL_12DSEM, ft_z22DANUAL_12DSEM
o_z22DANUAL_12DSEM = Null: t_z22DANUAL_12DSEM = Null: ft_z22DANUAL_12DSEM = 131
Dim rf_z22DANUAL_12DSEM, rt_z22DANUAL_12DSEM
%>
<%
...
<% End If %>
<div id="underline">
	<h1>Asignaturas Historicas</h1>
</div>
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Asignaturas_Historicassmry.asp?export=excel&acc=<%=Request("acc")%>"><img src="images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If sExport = "" Then %>
</div></td></tr>
...
&nbsp;&nbsp;<a href="Asignaturas_Historicassmry.asp?cmd=reset&acc=<%=Request("acc")%>">Resetear Filtros</a>
<% End If %>
<br><br>
<div id="ewrptExtFilterPanel"<%= sDivDisplay %>>
<!-- Search form (begin) -->
<form name="fAsignaturas_Historicassummaryfilter" id="fAsignaturas_Historicassummaryfilter" action="Asignaturas_Historicassmry.asp?acc=<%=Request("acc")%>" class="ewForm" onSubmit="return ewrpt_ValidateExtFilter(this);">
...
%>
	<tr>
		...
		<select name="sv_FACULTAD" id="sv_FACULTAD"<% If sClearExtFilter = "Asignaturas_Historicas_FACULTAD" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
%>
	...
	<tr>
		...
		<td><span class="ewrptSearchOpr">:</span></td>
		<td colspan="4"><span class="ewRptSearchOpr">
		<select name="sv_CARRERA" id="sv_CARRERA"<% If sClearExtFilter = "Asignaturas_Historicas_CARRERA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
<% If sClearExtFilter = "Asignaturas_Historicas_JORNADA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">JORNADA</span></td>
		<td><span class="ewrptSearchOpr">:
		    <input type="hidden" name="so1_JORNADA" id="so1_JORNADA" value="="></span></td>
		<td>
...
<% If sClearExtFilter = "Asignaturas_Historicas_CODRAMO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Asignaturas_Historicas_CODSECC" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Asignaturas_Historicas_ANO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Asignaturas_Historicas_PERIODO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Asignaturas_Historicas_CODPROF" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">CODIGO PROFESOR</span></td>
		<td><span class="ewrptSearchOpr">:
		    <input type="hidden" name="so1_CODPROF" id="so1_CODPROF" value="="></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
<input type="text" name="sv1_CODPROF" id="sv1_CODPROF" size="30" maxlength="30" value="<%= Server.HTMLEncode(sv1_CODPROF&"") %>"<%= sClearInputClass %>>
</span></td>
			</tr></table>			
		</td>
	</tr>
...
<%= ewrpt_ViewValue(x_NOMBRES) %>
		...
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_NUMNOTAS) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_ASISTENCIA) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCNP) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT1) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT2) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT3) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT4) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT5) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT6) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT7) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT8) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT9) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_PORCERT10) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_TIPO) %>
</td>
		<td<%= sItemRowClass %>>
<%= ewrpt_ViewValue(x_z22DANUAL_12DSEM) %>
</td>
	</tr>
<%
...
<form action="Asignaturas_Historicassmry.asp?acc=<%=Request("acc")%>" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.FirstButton.Start %>&acc=<%=Request("acc")%>"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<% Else %>
	<td><img src="rptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<% End If %>
<!--previous page button-->
	<% If Pager.PrevButton.Enabled Then %>
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.PrevButton.Start %>&acc=<%=Request("acc")%>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<% Else %>
...
<!--next page button-->
	...
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.NextButton.Start %>&acc=<%=Request("acc")%>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<% Else %>
	<td><img src="rptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<% End If %>
<!--last page button-->
	<% If Pager.LastButton.Enabled Then %>
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.LastButton.Start %>&acc=<%=Request("acc")%>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<% Else %>
...
Sub GetRow(opt)
	...
	If Not rs.Eof Then
		...
		x_NUMNOTAS = ewrpt_GetValue(rs("NUMNOTAS"))
		x_ASISTENCIA = ewrpt_GetValue(rs("ASISTENCIA"))
		If Not IsNull(x_ASISTENCIA) Then x_ASISTENCIA = CDbl(x_ASISTENCIA)
		x_PORCNP = ewrpt_GetValue(rs("PORCNP"))
		If Not IsNull(x_PORCNP) Then x_PORCNP = CDbl(x_PORCNP)
		x_PORCERT1 = ewrpt_GetValue(rs("PORCERT1"))
		If Not IsNull(x_PORCERT1) Then x_PORCERT1 = CDbl(x_PORCERT1)
		x_PORCERT2 = ewrpt_GetValue(rs("PORCERT2"))
		If Not IsNull(x_PORCERT2) Then x_PORCERT2 = CDbl(x_PORCERT2)
		x_PORCERT3 = ewrpt_GetValue(rs("PORCERT3"))
		If Not IsNull(x_PORCERT3) Then x_PORCERT3 = CDbl(x_PORCERT3)
		x_PORCERT4 = ewrpt_GetValue(rs("PORCERT4"))
		If Not IsNull(x_PORCERT4) Then x_PORCERT4 = CDbl(x_PORCERT4)
		x_PORCERT5 = ewrpt_GetValue(rs("PORCERT5"))
		If Not IsNull(x_PORCERT5) Then x_PORCERT5 = CDbl(x_PORCERT5)
		x_PORCERT6 = ewrpt_GetValue(rs("PORCERT6"))
		If Not IsNull(x_PORCERT6) Then x_PORCERT6 = CDbl(x_PORCERT6)
		x_PORCERT7 = ewrpt_GetValue(rs("PORCERT7"))
		If Not IsNull(x_PORCERT7) Then x_PORCERT7 = CDbl(x_PORCERT7)
		x_PORCERT8 = ewrpt_GetValue(rs("PORCERT8"))
		If Not IsNull(x_PORCERT8) Then x_PORCERT8 = CDbl(x_PORCERT8)
		x_PORCERT9 = ewrpt_GetValue(rs("PORCERT9"))
		If Not IsNull(x_PORCERT9) Then x_PORCERT9 = CDbl(x_PORCERT9)
		x_PORCERT10 = ewrpt_GetValue(rs("PORCERT10"))
		If Not IsNull(x_PORCERT10) Then x_PORCERT10 = CDbl(x_PORCERT10)
		x_TIPO = ewrpt_GetValue(rs("TIPO"))
		x_z22DANUAL_12DSEM = ewrpt_GetValue(rs("2-ANUAL 1-SEM"))
		If Not IsNull(x_z22DANUAL_12DSEM) Then x_z22DANUAL_12DSEM = CDbl(x_z22DANUAL_12DSEM)
		val(1) = x_FACULTAD
		val(2) = x_CARRERA
		val(3) = x_RAMO
		val(4) = x_JORNADA
...
Function GetExtendedFilter()
	...
	ElseIf Request.QueryString("cmd") = "reset" Then
		...
		Call SetSessionDropDownValue(sv_FACULTAD, "Asignaturas_Historicas_FACULTAD")

		' Field CARRERA
		Call SetSessionDropDownValue(sv_CARRERA, "Asignaturas_Historicas_CARRERA")

		' Field JORNADA
		Call SetSessionFilterValues(sv1_JORNADA, so1_JORNADA, sc_JORNADA, sv2_JORNADA, so2_JORNADA, "Asignaturas_Historicas_JORNADA")

		' Field CODRAMO
		Call SetSessionFilterValues(sv1_CODRAMO, so1_CODRAMO, sc_CODRAMO, sv2_CODRAMO, so2_CODRAMO, "Asignaturas_Historicas_CODRAMO")

		' Field CODSECC
		Call SetSessionFilterValues(sv1_CODSECC, so1_CODSECC, sc_CODSECC, sv2_CODSECC, so2_CODSECC, "Asignaturas_Historicas_CODSECC")

		' Field ANO
		Call SetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Asignaturas_Historicas_ANO")

		' Field PERIODO
		Call SetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Asignaturas_Historicas_PERIODO")

		' Field CODPROF
		Call SetSessionFilterValues(sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF, "Asignaturas_Historicas_CODPROF")
	...
	Else
		...
		ElseIf Not IsArray(sv_FACULTAD) Then
			If sv_FACULTAD <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Asignaturas_Historicas_FACULTAD")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
		...
		ElseIf Not IsArray(sv_CARRERA) Then
			If sv_CARRERA <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Asignaturas_Historicas_CARRERA")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
		...
		' Field CODPROF
		If GetFilterValues(sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF, "CODPROF") Then
			bSetupFilter = True ' Set up filter required
			bRestoreSession = False ' Do not restore from session
		End If
	End If
	...
	If bRestoreSession Then
		...
		' Field FACULTAD
		Call GetSessionDropDownValue(sv_FACULTAD, "Asignaturas_Historicas_FACULTAD")

		' Field CARRERA
		Call GetSessionDropDownValue(sv_CARRERA, "Asignaturas_Historicas_CARRERA")

		' Field JORNADA
		Call GetSessionFilterValues(sv1_JORNADA, so1_JORNADA, sc_JORNADA, sv2_JORNADA, so2_JORNADA, "Asignaturas_Historicas_JORNADA")

		' Field CODRAMO
		Call GetSessionFilterValues(sv1_CODRAMO, so1_CODRAMO, sc_CODRAMO, sv2_CODRAMO, so2_CODRAMO, "Asignaturas_Historicas_CODRAMO")

		' Field CODSECC
		Call GetSessionFilterValues(sv1_CODSECC, so1_CODSECC, sc_CODSECC, sv2_CODSECC, so2_CODSECC, "Asignaturas_Historicas_CODSECC")

		' Field ANO
		Call GetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Asignaturas_Historicas_ANO")

		' Field PERIODO
		Call GetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Asignaturas_Historicas_PERIODO")

		' Field CODPROF
		Call GetSessionFilterValues(sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF, "Asignaturas_Historicas_CODPROF")
	End If
	...
	' Field CODPROF
	Call BuildExtendedFilter(sFilter, "CODPROF", "[CODPROF]", EW_REPORT_DATATYPE_STRING, 0, sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF)
...
Sub LoadDefaultFilters()
	...
	so1d_JORNADA = "=" ' Default search operator 1
	...
	' Field CODPROF
	' sv1d_CODPROF = Date ' Default value is today
	' so1d_CODPROF = "<=" ' Default operator is "<="

	sv1d_CODPROF = Null ' Default ext filter value 1
	sv2d_CODPROF = Null ' Default ext filter value 2 (if operator 2 is enabled)
	so1d_CODPROF = "=" ' Default search operator 1
	so2d_CODPROF = "=" ' Default search operator 2 (if operator 2 is enabled)
	scd_CODPROF = "AND" ' Default search condition (if operator 2 is enabled)
	sv1_CODPROF = sv1d_CODPROF
	sv2_CODPROF = sv2d_CODPROF
	so1_CODPROF = so1d_CODPROF
	so2_CODPROF = so2d_CODPROF
	sc_CODPROF = scd_CODPROF
...
Function CheckFilter()
	...
	' Check CODPROF Text filter
	If TextFilterApplied(sv1_CODPROF, sv2_CODPROF, so1_CODPROF, so2_CODPROF, sc_CODPROF, _
		sv1d_CODPROF, sv2d_CODPROF, so1d_CODPROF, so2d_CODPROF, scd_CODPROF) Then
		CheckFilter = True
		Exit Function
	End If
	CheckFilter = False
...
Sub ShowFilterList()
	...
	sExtWrk = ""
	sWrk = ""
	Call BuildExtendedFilter(sExtWrk, "CODPROF", "[CODPROF]", EW_REPORT_DATATYPE_STRING, 0, sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF)
	If sExtWrk <> "" Or sWrk <> "" Then sFilterList = sFilterList & "CODPROF<br>"
	If sExtWrk <> "" Then sFilterList = sFilterList & "&nbsp;&nbsp;" & sExtWrk & "<br>"
	If sWrk <> "" Then sFilterList = sFilterList & "&nbsp;&nbsp;" & sWrk & "<br>"
...
Function getSort()
	...
	If Request.QueryString("cmd").Count > 0 Then
		...
		If sCmd = "resetsort" Then
			...
			Session("sort_Asignaturas_Historicas_FACULTAD") = ""
			Session("sort_Asignaturas_Historicas_CARRERA") = ""
			Session("sort_Asignaturas_Historicas_RAMO") = ""
			Session("sort_Asignaturas_Historicas_JORNADA") = ""
			Session("sort_Asignaturas_Historicas_CODRAMO") = ""
			Session("sort_Asignaturas_Historicas_CODSECC") = ""
			Session("sort_Asignaturas_Historicas_ANO") = ""
			Session("sort_Asignaturas_Historicas_PERIODO") = ""
			Session("sort_Asignaturas_Historicas_CODPROF") = ""
			Session("sort_Asignaturas_Historicas_AP_PATER") = ""
			Session("sort_Asignaturas_Historicas_AP_MATER") = ""
			Session("sort_Asignaturas_Historicas_NOMBRES") = ""
			Session("sort_Asignaturas_Historicas_NUMNOTAS") = ""
			Session("sort_Asignaturas_Historicas_ASISTENCIA") = ""
			Session("sort_Asignaturas_Historicas_PORCNP") = ""
			Session("sort_Asignaturas_Historicas_PORCERT1") = ""
			Session("sort_Asignaturas_Historicas_PORCERT2") = ""
			Session("sort_Asignaturas_Historicas_PORCERT3") = ""
			Session("sort_Asignaturas_Historicas_PORCERT4") = ""
			Session("sort_Asignaturas_Historicas_PORCERT5") = ""
			Session("sort_Asignaturas_Historicas_PORCERT6") = ""
			Session("sort_Asignaturas_Historicas_PORCERT7") = ""
			Session("sort_Asignaturas_Historicas_PORCERT8") = ""
			Session("sort_Asignaturas_Historicas_PORCERT9") = ""
			Session("sort_Asignaturas_Historicas_PORCERT10") = ""
			Session("sort_Asignaturas_Historicas_TIPO") = ""
			Session("sort_Asignaturas_Historicas_z22DANUAL_12DSEM") = ""
		End If
