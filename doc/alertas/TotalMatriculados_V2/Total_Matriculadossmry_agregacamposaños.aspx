...
<script runat="server">
    ...
    Public Class crTotal_Matriculados
		...
		Public ANOTIT As crField
		
		Public ANOEGR As crField
        ...
        Public Sub New(APage As AspNetReportMakerPage)
            ...
            ' ANOTIT
            ANOTIT = New crField("Total_Matriculados", "Total_Matriculados", "x_ANOTIT", "ANOTIT", "[ANOTIT]", 135, EWRPT_DATATYPE_DATE, 7)
            ANOTIT.Page = APage
            ANOTIT.ParentPage = APage.ParentPage
            ANOTIT.FldDefaultErrMsg = ReportLanguage.Phrase("IncorrectDateDMY").Replace("%s", "/")
            Fields.Add("ANOTIT", ANOTIT)
            ANOTIT.DateFilter = ""
            ANOTIT.SqlSelect = ""
            ANOTIT.SqlOrderBy = ""
			
            ' ANOEGR
            ANOEGR = New crField("Total_Matriculados", "Total_Matriculados", "x_ANOEGR", "ANOEGR", "[ANOEGR]", 135, EWRPT_DATATYPE_DATE, 7)
            ANOEGR.Page = APage
            ANOEGR.ParentPage = APage.ParentPage
            ANOEGR.FldDefaultErrMsg = ReportLanguage.Phrase("IncorrectDateDMY").Replace("%s", "/")
            Fields.Add("ANOEGR", ANOEGR)
            ANOEGR.DateFilter = ""
            ANOEGR.SqlSelect = ""
            ANOEGR.SqlOrderBy = ""			
    ...
    Public Class crTotal_Matriculados_summary
        ...
        Public Sub GetRow(opt As Integer)
            ...
            If (RowIndex < rs.Count) Then
				...
				Total_Matriculados.ANOTIT.DbValue = Row("ANOTIT")
				Total_Matriculados.ANOEGR.DbValue = Row("ANOEGR")
				...
				Val(31) = Total_Matriculados.ANOTIT.CurrentValue
				Val(32) = Total_Matriculados.ANOEGR.CurrentValue
            Else
				...
				Total_Matriculados.ANOTIT.DbValue = ""
				Total_Matriculados.ANOEGR.DbValue = ""
            End If
        End Sub
        ...
        Public Function GetRow() As Boolean
            ...
            If (HasRow) Then
				...
				Total_Matriculados.ANOTIT.DbValue = dr("ANOTIT")
				Total_Matriculados.ANOEGR.DbValue = dr("ANOEGR")
                Val(1) = Total_Matriculados.CODCLI.CurrentValue
                Val(2) = Total_Matriculados.DIG.CurrentValue
                Val(3) = Total_Matriculados.PATERNO.CurrentValue
                Val(4) = Total_Matriculados.MATERNO.CurrentValue
        ...
        Public Sub RenderRow()
            ...
            If (Total_Matriculados.RowType = EWRPT_ROWTYPE_TOTAL) Then ' Summary row
                ...
                ' ANOTIT
                Total_Matriculados.ANOTIT.ViewValue = Convert.ToString(Total_Matriculados.ANOTIT.Summary)
                'Total_Matriculados.ANOTIT.ViewValue = ew_FormatDateTime(Total_Matriculados.ANOTIT.ViewValue, 7)

                ' ANOEGR
                Total_Matriculados.ANOEGR.ViewValue = Convert.ToString(Total_Matriculados.ANOEGR.Summary)
            ...
            Else
                ...
                ' ANOTIT
                Total_Matriculados.ANOTIT.ViewValue = Convert.ToString(Total_Matriculados.ANOTIT.CurrentValue)
                Total_Matriculados.ANOTIT.ViewValue = ew_FormatDateTime(Total_Matriculados.ANOTIT.ViewValue, 7)
                Total_Matriculados.ANOTIT.CellAttrs("class") = IIf(RecCount Mod 2 <> 1, "ewTableAltRow", "ewTableRow")
				
                ' ANOEGR
                Total_Matriculados.ANOEGR.ViewValue = Convert.ToString(Total_Matriculados.ANOEGR.CurrentValue)
                Total_Matriculados.ANOEGR.ViewValue = ew_FormatDateTime(Total_Matriculados.ANOEGR.ViewValue, 7)
                Total_Matriculados.ANOEGR.CellAttrs("class") = IIf(RecCount Mod 2 <> 1, "ewTableAltRow", "ewTableRow")				
            ...
            ' ANOTIT
            Total_Matriculados.ANOTIT.HrefValue = ""
			
            ' ANOEGR
            Total_Matriculados.ANOEGR.HrefValue = ""			
        ...
        Public Function GetSort() As String
            ...
            If ew_NotEmpty(ew_Get("cmd")) Then
                ...
                If ew_SameText(sCmd, "resetsort") Then
                    ...
                    Total_Matriculados.ANOTIT.Sort = ""
                    Total_Matriculados.ANOEGR.Sort = ""					
                End If
...
<td class="ewTableHeader">
<% If (ew_NotEmpty(Total_Matriculados.Export)) Then %>
<%= Total_Matriculados.ANOTIT.FldCaption() %>
<% Else %>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<% If (ew_Empty(Total_Matriculados.SortUrl(Total_Matriculados.ANOTIT))) Then %>
		<td style="vertical-align: bottom;"><%= Total_Matriculados.ANOTIT.FldCaption() %></td>
<% Else %>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<%= Total_Matriculados.SortUrl(Total_Matriculados.ANOTIT) %>',0);"><%= Total_Matriculados.ANOTIT.FldCaption() %></td><td style="width: 10px;">
		<% If (Total_Matriculados.ANOTIT.Sort = "ASC") Then %><img src="aspxrptimages/sortup.gif" width="10" height="9" border="0"><% ElseIf (Total_Matriculados.ANOTIT.Sort = "DESC") Then %><img src="aspxrptimages/sortdown.gif" width="10" height="9" border="0"><% End If %></td>
<% End If %>
	</tr></table>
<% End If %>
</td>
...
<td class="ewTableHeader">
<% If (ew_NotEmpty(Total_Matriculados.Export)) Then %>
<%= Total_Matriculados.ANOEGR.FldCaption() %>
<% Else %>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<% If (ew_Empty(Total_Matriculados.SortUrl(Total_Matriculados.ANOEGR))) Then %>
		<td style="vertical-align: bottom;"><%= Total_Matriculados.ANOEGR.FldCaption() %></td>
<% Else %>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<%= Total_Matriculados.SortUrl(Total_Matriculados.ANOEGR) %>',0);"><%= Total_Matriculados.ANOEGR.FldCaption() %></td><td style="width: 10px;">
		<% If (Total_Matriculados.ANOEGR.Sort = "ASC") Then %><img src="aspxrptimages/sortup.gif" width="10" height="9" border="0"><% ElseIf (Total_Matriculados.ANOEGR.Sort = "DESC") Then %><img src="aspxrptimages/sortdown.gif" width="10" height="9" border="0"><% End If %></td>
<% End If %>
	</tr></table>
<% End If %>
</td>
...
<div<%= Total_Matriculados.COMUNAALUMNO.ViewAttributes%>><%= Total_Matriculados.COMUNAALUMNO.ListViewValue%></div>
		...
		<td<%= Total_Matriculados.ANOTIT.CellAttributes %>>
<div<%= Total_Matriculados.ANOTIT.ViewAttributes%>><%= Total_Matriculados.ANOTIT.ListViewValue%></div>
</td>

		<td<%= Total_Matriculados.ANOEGR.CellAttributes %>>
<div<%= Total_Matriculados.ANOEGR.ViewAttributes%>><%= Total_Matriculados.ANOEGR.ListViewValue%></div>
</td>
