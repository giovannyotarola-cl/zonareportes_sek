...
Public Partial Class AspNetReportMaker4_listado_morosos
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "listado_morosos" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "S3mQk2Vs6Yz70Dmc" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/listado_morosos.css" ' Project stylesheet file name
