...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_listado_morosos Then
			ParentPage = CType(Page, AspNetReportMaker4_listado_morosos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_listado_morosos.crLanguage(New AspNetReportMaker4_listado_morosos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
