...
Public Partial Class AspNetReportMaker4_CuentasGoogle
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "CuentasGoogle" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "#s_CoXZia&4vgxKV" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/CuentasGoogle.css" ' Project stylesheet file name
