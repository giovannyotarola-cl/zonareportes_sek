...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_CuentasGoogle Then
			ParentPage = CType(Page, AspNetReportMaker4_CuentasGoogle)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_CuentasGoogle.crLanguage(New AspNetReportMaker4_CuentasGoogle.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
