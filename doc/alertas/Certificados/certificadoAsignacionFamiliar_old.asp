...
<div id="ewLayout">
    <div id="underline">
		<h1>Certificado de Asignación Familiar</h1>
	</div>
    <div class="formulario">
        <form name="proyecto" id="proyecto" action="#" method="post" class="ewForm">
            <table class="ewContentTable ewContentData">
                                ...
                                <td>
                                	<table class="ewContentTable">
                                    	<tr>
                                        	<td>Mes</td>
                                            <td>
                                            	<select name="mesSemestreD" id="mesSemestreD">
                                            ...
                                            <td>Periodo</td>
                                            <td>
                                            	<select name="perSemestreD" id="perSemestreD">
                ...
                <tr>
                    <td valign="top" class="ewDataTop">Curso</td>
                    <td class="ewDataTop">
                    	<select name="perCursoD" id="perCursoD">
                           	<option value="0"></option>
                            <option value="1" selected="selected">1</option>
                            <option value="2">2</option>
                ...
                <tr>
                    <td colspan="2"><input id="verAsignacionFamiliar" type="button" value="ver certificado" /></td>
                </tr>
            </table>
        </form>
    </div>
