            ...
            <table class="ewContentTable ewContentData">
                <tr>
                    ...
                    <td class="ewDataTop">
                        ...
                        <a href="http://zonareportes.uisek.cl/doc/alertas/Certificados/buscaAlumno.asp?keepThis=true&TB_iframe=true&height=350&width=700" title="Buscar Alumno" class="thickbox">buscar</a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><input id="verEgreso" type="button" value="ver certificado" /></td>
                </tr>
            </table>
        </form>
    </div>
