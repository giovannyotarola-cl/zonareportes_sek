...
Public Class ImageConversions
    ...
    Protected Sub CreatePhoto()
        ...
        Try
            ...
            'Para probar en local cambiar el F a D y crear carpeta Temp
    ...
    Private Sub store_pic_Sql(ByVal img As System.Drawing.Image)
        ...
        Dim sqlCheck As String = "SELECT CODCLI from Matricula.foto_alumno WHERE CODCLI = '" + alumno + "'"
        da = New SqlDataAdapter(sqlCheck, conn)
        da.Fill(ds)

        If ds.Tables(0).Rows.Count > 0 Then
            sqlInsertar = "UPDATE Matricula.foto_alumno set FOTO = @imgData WHERE CODCLI = '" + alumno + "'"
        Else
            sqlInsertar = "INSERT INTO Matricula.foto_alumno (CODCLI, FOTO) VALUES ('" + alumno + "', @imgData)"
        End If
