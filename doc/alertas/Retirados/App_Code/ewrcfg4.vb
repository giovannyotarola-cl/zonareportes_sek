...
Public Partial Class AspNetReportMaker4_alumnos_retirados_2013
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "alumnos_retirados_2013" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "taJ&y473nIh0Egnz" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/alumnos_retirados_2013.css" ' Project stylesheet file name
