...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_alumnos_retirados_2013 Then
			ParentPage = CType(Page, AspNetReportMaker4_alumnos_retirados_2013)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_alumnos_retirados_2013.crLanguage(New AspNetReportMaker4_alumnos_retirados_2013.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
