...
Const EW_REPORT_RANDOM_KEY = "&FMQm30jut7qy2Sd" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "ramossinponderar" ' Project Name
Const EW_REPORT_PROJECT_VAR = "ramossinponderar" ' Project Var
