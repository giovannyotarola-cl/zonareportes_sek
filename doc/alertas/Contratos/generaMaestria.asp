...
cnIndex.Open "driver={SQL Server};server=192.168.100.226; database=MatriculaUMasEc; uid=sa;pwd=Sa070507"
	...
	'sqlAlumnos = "select Nombre+' '+'Apellido 1'+' '+'Apellido 2' AS nombre, Address+', ciudad de '+City AS domicilio, 'Phone No_' as telefono, Nacionalidad as nacionalidad, 'VAT Registration No_' as cedula from dbo.Customer where ('VAT Registration No_' = '"&request("codcli")&"') "
...
<% if rsAlumnos.eof = false Then %>
      <div class = "columna1">
        ...
        <strong>SEGUNDO:</strong>   El valor de la matrícula es de $ <%= request("valMat")%>, y el de los servicios educacionales que <strong>EL CONTRATANTE</strong> contrata según la cláusula anterior, es de $ <%= request("valSem")%>, cuyos pagos <strong>EL CONTRATANTE</strong> se compromete a realizar al contado o en cuotas por montos y con los vencimientos indicados en el presente contrato. <br /><br />
          ...
          b) Dinero efectivo ( ); 
          <br />
          c) Cheque Certificado ( ), No. ______________ del Banco ______________ .          
          <br />
          Clave de Abono: Pago garantía IECE-Cheque
