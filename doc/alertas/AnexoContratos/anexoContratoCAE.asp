            ...
            <table class="ewContentTable ewContentData">
               ...
               <!-- <tr>
                ...
                <td height="23" class="ewDataTop">Semestre actual: </td>
                 ...
                 <tr>
                	<td class="ewDataTop">Valor de Credito Solidario</td>
                    <td class="ewDataTop">
                    	<input type="text" name="valorCredito" id="valorCredito" value=""/>
                    </td>
                </tr>
                 <tr>
                	<td class="ewDataTop">Valor Arancel Universidad</td>
                    <td class="ewDataTop">
                ...
                <tr>
                    <td colspan="2"><input id="verAnexoCAE" type="button" value="Ver Anexo" /></td>
                </tr>
            </table>
        </form>
    </div>
