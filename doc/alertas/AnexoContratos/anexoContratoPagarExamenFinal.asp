        ...
        <form name="proyecto" id="proyecto" action="#" method="post" class="ewForm">
            <table class="ewContentTable ewContentData">
               ...
               <!-- <tr>
                ...
                <tr>
                	<td class="ewDataTop">Valor Matricula</td>
                    <td class="ewDataTop">
                    	<input type="text" name="valorMatricula" id="valorMatricula" value=""/>
                    </td>
                </tr>
                 <tr>
                	<td class="ewDataTop">Valor Examen Final</td>
                    <td class="ewDataTop">
                    	<input type="text" name="valorExamenFinal" id="valorExamenFinal" value=""/>
                    </td>
                </tr>
                <tr>
                	<td class="ewDataTop">Cantidad de Cuotas</td>
                    <td class="ewDataTop">
                ...
                <tr>
                    <td colspan="2"><input id="verAnexoPagarExamenFinal" type="button" value="Ver Anexo" /></td>
                </tr>
            </table>
        </form>
    </div>
