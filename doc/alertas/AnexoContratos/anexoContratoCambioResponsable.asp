            ...
            <table class="ewContentTable ewContentData">
               ...
               <!-- <tr>
                ...
                <td height="23" class="ewDataTop">Semestre actual: </td>
                 ...
                 <tr>
                	<td class="ewDataTop">Nombre Nuevo Responsable <span class="obligatorio">*</span></td>
                    <td class="ewDataTop">
                    	<input type="text" name="nombreResponsable" id="nombreResponsable" value=""/>
                    </td>
                </tr>
                 <tr>
                	<td class="ewDataTop">Apellidos Nuevo Responsable <span class="obligatorio">*</span></td>
                    <td class="ewDataTop">
                    	<input type="text" name="apellidosResponsable" id="apellidosResponsable" value=""/>
                    </td>
                </tr>
                <tr>
                	<td class="ewDataTop">Rut Nuevo Responsable <span class="obligatorio">*</span></td>
                    <td class="ewDataTop">
                    	<input type="text" name="rutResponsable" id="rutResponsable" value=""/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><input id="verAnexoCambioResponsable" type="button" value="Ver Anexo" /></td>
                </tr>
            </table>
        </form>
    </div>
