...
'
Public Partial Class AspNetReportMaker4_solicitudesCertificados
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "solicitudesCertificados" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "5iO3Ig6kvq4SgMD0" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/solicitudesCertificados.css" ' Project stylesheet file name
	...
	Public Shared EWRPT_DB_CONNECTION_STRING As String = "Persist Security Info=False;Data Source=192.168.100.226;Initial Catalog=SekInternet;User Id=sa;Password=Sa070507"		
