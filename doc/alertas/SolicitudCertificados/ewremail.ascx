...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_solicitudesCertificados Then
			ParentPage = CType(Page, AspNetReportMaker4_solicitudesCertificados)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_solicitudesCertificados.crLanguage(New AspNetReportMaker4_solicitudesCertificados.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
