...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_EncuestaDocenteAutoevaluacion Then
			ParentPage = CType(Page, AspNetReportMaker4_EncuestaDocenteAutoevaluacion)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_EncuestaDocenteAutoevaluacion.crLanguage(New AspNetReportMaker4_EncuestaDocenteAutoevaluacion.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
