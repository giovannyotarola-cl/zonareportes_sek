...
Public Partial Class AspNetReportMaker4_EncuestaDocenteAutoevaluacion
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "EncuestaDocenteAutoevaluacion" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "R&3YM6gAO3M#F2#q" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/EncuestaDocenteAutoevaluacion.css" ' Project stylesheet file name
