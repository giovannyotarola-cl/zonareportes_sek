...
'
Public Partial Class AspNetReportMaker4_CVSIES
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "CVSIES" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "N_7Z6Ky5wsX&7q2G" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/CVSIES.css" ' Project stylesheet file name
