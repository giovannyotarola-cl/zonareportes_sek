...
Public Partial Class AspNetReportMaker4_cargaCaeAnt2012
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "cargaCaeAnt2012" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "40TDnY4&w60V%Dno" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/cargaCaeAnt2012.css" ' Project stylesheet file name
