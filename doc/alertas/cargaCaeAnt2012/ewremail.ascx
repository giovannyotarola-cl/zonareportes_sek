...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_cargaCaeAnt2012 Then
			ParentPage = CType(Page, AspNetReportMaker4_cargaCaeAnt2012)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_cargaCaeAnt2012.crLanguage(New AspNetReportMaker4_cargaCaeAnt2012.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
