...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_consultaAvanceCreditos Then
			ParentPage = CType(Page, AspNetReportMaker4_consultaAvanceCreditos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_consultaAvanceCreditos.crLanguage(New AspNetReportMaker4_consultaAvanceCreditos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
