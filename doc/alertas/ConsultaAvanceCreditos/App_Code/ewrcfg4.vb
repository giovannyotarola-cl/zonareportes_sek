...
Public Partial Class AspNetReportMaker4_consultaAvanceCreditos
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "consultaAvanceCreditos" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "rU0e7dzrqBuP5PM6" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/consultaAvanceCreditos.css" ' Project stylesheet file name
