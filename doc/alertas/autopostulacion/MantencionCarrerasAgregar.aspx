<%@ Page Title="Principal" Language="C#" MasterPageFile="~/SiteMenu.Master" AutoEventWireup="true" CodeBehind="MantencionCarrerasAgregar.aspx.cs" Inherits="AutoPostulacion.MantencionCarrerasAgregar" %>
...
<asp:Content ID="MantencionCarreras" ContentPlaceHolderID="MainContent" runat="server">
    <script language="javascript">
        ...
        function Confirmar() {
            if (confirm('Desea Agregar esta carrera?'))
                return true;
            else
                return false;
        }
    ...
    <div class="titulo text-center">
        <h1 style="background-color: #FFFFFF; color: #2E89B6;">Agregar Carrera</h1>
    </div>
    ...
    <table class="nav-justified" style="width: 95%">
        ...
        <tr>
            <td style="width: 20%">
                <asp:Button ID="btnAgregarCarrera" runat="server" CssClass="btn btn-info btn-xs" Text="Agregar Carrera" Visible="true" OnClientClick="return Confirmar();" OnClick="btnAgregarCarrera_Click" />
            </td>
