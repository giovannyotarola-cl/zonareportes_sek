    ...
    public partial class _SubirArchivos : System.Web.UI.Page
    {
        ...
        protected void buscaarchivo()
        {
            ...
            if(EstContrato == "Rechazado")
            {
                ...
                lbl_hayArchivosCargados.Text = "Usted presenta archivos cargados en estado rechazado los cuales están habilitados para volver a subir.";
            }
