...
<%--    <script>
    ...
    <script>
        function mostrardoc(rut) {
            var id_accion = "0";
            
            if (rut != "") {               
                document.getElementById("frm_RevisionArchivos").src = "archivos.aspx?t=" + rut + "&a=" + id_accion;
        ...
        <div id="content_top">
            ...
            <div id="content_center_right">
                <table id="example" class="table table-hover" align="center" width="190%" style="border-color: azure; font-size: 10px;">
                    <thead>
                        <tr>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Rut</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Nombre</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Codigo Alumno</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Sexo</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Mail</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Telefono</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Región</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Comuna</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Facultad</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Carrera</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Cohorte</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Jornada</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Estado</th>   
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Descripcion Estado</th>                  
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Contrato</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Anexo Compromiso</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Pagaré</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Estado Postulante</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Ver Estado</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Matriculado</th>
                            <th style="background-color: #5bc0de; font-size: 12px; text-align: center; ">Fecha Matricula</th>
                        </tr>
                    </thead>
