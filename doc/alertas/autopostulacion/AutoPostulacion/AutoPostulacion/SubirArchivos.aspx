...
<asp:Content ID="SubirArchivo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified" style="width: 95%">
        <tr>
            ...
            <td style="width: 40%">
                <asp:FileUpload ID="ruta_ArchivoContrato" runat="server" Width="90%" Visible="false" required="required"/>
            </td>
            <td style="width: 30%">
        ...
        <tr>
            ...
            <td style="width: 40%">
                <asp:FileUpload ID="ruta_ArchivoDetalle" runat="server" Width="90%" Visible="false" required="required"/>
            </td>
            <td style="width: 30%">
        ...
        <tr>
            ...
            <td style="width: 40%">
                <asp:FileUpload ID="ruta_ArchivoPagare" runat="server" Width="90%" Visible="false" required="required" />
            </td>
            <td style="width: 30%">
