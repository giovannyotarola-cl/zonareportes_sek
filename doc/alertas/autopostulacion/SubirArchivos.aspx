...
<asp:Content ID="SubirArchivo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified" style="width: 95%">
        <tr>
            <td style="width: 5%; height: 27px;">
                <asp:Label ID="lbl_Rut" runat="server" Text="Rut" Width="5%" Font-Bold="True"></asp:Label>
            </td>
    ...
    <table class="nav-justified" style="width: 95%">
        ...
        <tr>
            <td>
                <asp:Label ID="lbl_hayArchivosCargados" runat="server" Visible="False" Font-Bold="True"></asp:Label>                
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table class="nav-justified" style="width: 95%">
        <tr>
            <td style="width: 20%">
                <asp:Label ID="lbl_ArchivoContrato" runat="server" Visible="False" Font-Bold="True">Contrato</asp:Label>
            </td>
            <td style="width: 40%">
                <asp:FileUpload ID="ruta_ArchivoContrato" runat="server" Width="90%" Visible="false" accept="application/pdf" required="required"/>
            </td>
            <td style="width: 30%">
        ...
        <tr>
            <td style="width: 20%">
                <asp:Label ID="lbl_ArchivoDetalle" runat="server" Visible="False" Font-Bold="True">Anexo Compromiso</asp:Label>
            </td>
            <td style="width: 40%">
                <asp:FileUpload ID="ruta_ArchivoDetalle" runat="server" Width="90%" Visible="false" accept="application/pdf" required="required"/>
            </td>
            <td style="width: 30%">
        ...
        <tr>
            <td style="width: 20%">
                <asp:Label ID="lbl_ArchivoPagare" runat="server" Visible="False" Font-Bold="True">Pagaré</asp:Label>
            </td>
            <td style="width: 40%">
                <asp:FileUpload ID="ruta_ArchivoPagare" runat="server" Width="90%" Visible="false" accept="application/pdf" required="required" />
            </td>
            <td style="width: 30%">
