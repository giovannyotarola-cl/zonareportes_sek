...
<asp:Content ID="Condiciones" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <h1>OPCION NO DISPONIBLE (MODO PRUEBAS)</h1>
    </div>
...
Al aceptar estas condiciones, se procederá a generar la documentación necesaria, para poder continuar con el proceso. Usted deberá imprimir estos archivos, los cuales luego de ser leído y aceptados, tendrán que ser firmados, timbrados con su huella digital (donde corresponda) y digitalizados, para ser envíados de acuerdo a las instrucciones indicadas.
