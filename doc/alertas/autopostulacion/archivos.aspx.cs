...
namespace AutoPostulacion
{
    public partial class archivos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                BuscaDatos();
                if (EstHistContrato.Trim() != "" && EstHistAnexCon.Trim() != "" && EstHistPagare.Trim() != "")
                {
                    try
                    {
                        DataSet ds1;
                ...
                {
                    DropEstContrato.Items.Add("ARCHIVO SIN CARGAR");
                    DropEstAnexCon.Items.Add("ARCHIVO SIN CARGAR");
                    DropEstPagare.Items.Add("ARCHIVO SIN CARGAR");
                }
            }
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (EstHistContrato.Trim() != "" && EstHistAnexCon.Trim() != "" && EstHistPagare.Trim() != "")
            {
                ...
                if (estActualAnxcontrato == "Aprobado" && estActualAnxcontrato == "Aprobado" && estActualPagare == "Aprobado")
                {
                    estadoPostul = "Aprobado";
                    mensaje = Conexion.GuardarEstados(rut, ANO, PERIODO, "", "", "", "", "", estadoPostul);
                }

                if (estActualAnxcontrato == "Rechazado" && estActualAnxcontrato == "Rechazado" && estActualPagare == "Rechazado")
                {
                    estadoPostul = "Rechazado";
                    mensaje = Conexion.GuardarEstados(rut, ANO, PERIODO, "", "", "", "", "", estadoPostul);
                }
            ...
            {
                string script = @"alert('Archivo sin cargar, no se puede cambiar de estado.');";
                ScriptManager.RegisterStartupScript(this, typeof(Page), "alerta", script, true);
            }
