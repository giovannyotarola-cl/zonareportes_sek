<%@ Page ClassName="logout" Language="C#" MasterPageFile="rmasterpage.master" Inherits="AspNetReportMaker4_project1" %>
...
<script runat="server">
	...
	// Page object
	public crrptlogout rptlogout;

	//
	// Page class
	//
	public class crrptlogout: AspNetReportMakerPage, IDisposable {
		...
		// ASP.NET page object
		public logout AspNetPage { 
			get { return (logout)m_ParentPage; }
		}

		//
		// Page class constructor
		//
		public crrptlogout(AspNetReportMaker4_project1 APage) {		
			m_ParentPage = APage;
			m_Page = this;
			m_PageID = "rptlogout";
		...
		public void Page_Main() {
			if (HttpContext.Current.Request.Cookies[EWRPT_PROJECT_NAME] != null)	{
				...
				if (ew_Cookie["autologin"] == "")	{	// Not auto login					
	...
	protected void Page_Load(object sender, System.EventArgs e) {
		...
		// Page init
		rptlogout = new crrptlogout(this);
		rptlogout.Page_Init();
	...
	protected void Page_Unload(object sender, System.EventArgs e) {
		...
		// Dispose page object
		if (rptlogout != null) rptlogout.Dispose();
	}
</script>
