...
'
Public Partial Class AspNetReportMaker4_project1
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "project1" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "2HkFW1rUlfAmg6L9" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/project1.css" ' Project stylesheet file name
	...
	Public Shared EWRPT_DB_CONNECTION_STRING As String = "Persist Security Info=False;Data Source=192.168.100.226;Initial Catalog=ZonaReportes_Chile;User Id=sa;Password=Sa070507"		
