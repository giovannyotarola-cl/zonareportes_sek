...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_EvaluacionJefeCarrera Then
			ParentPage = CType(Page, AspNetReportMaker4_EvaluacionJefeCarrera)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_EvaluacionJefeCarrera.crLanguage(New AspNetReportMaker4_EvaluacionJefeCarrera.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
