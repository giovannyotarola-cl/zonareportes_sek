...
'
Public Partial Class AspNetReportMaker4_EvaluacionJefeCarrera
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "EvaluacionJefeCarrera" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "2&RYb#SH%aASd&6Y" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/EvaluacionJefeCarrera.css" ' Project stylesheet file name
