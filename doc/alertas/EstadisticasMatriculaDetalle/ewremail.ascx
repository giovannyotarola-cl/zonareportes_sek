...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_EstadisticasMatriculaDetalle Then
			ParentPage = CType(Page, AspNetReportMaker4_EstadisticasMatriculaDetalle)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_EstadisticasMatriculaDetalle.crLanguage(New AspNetReportMaker4_EstadisticasMatriculaDetalle.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
