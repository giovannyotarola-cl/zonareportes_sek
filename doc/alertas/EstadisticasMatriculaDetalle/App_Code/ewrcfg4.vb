...
Public Partial Class AspNetReportMaker4_EstadisticasMatriculaDetalle
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "EstadisticasMatriculaDetalle" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "32tvf7q74s___A1o" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/EstadisticasMatriculaDetalle.css" ' Project stylesheet file name
