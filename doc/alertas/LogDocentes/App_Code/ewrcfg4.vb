...
Public Partial Class AspNetReportMaker4_Log_Docentes
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "Log_Docentes" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "1XE%D870NBW%nLMv" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/Log_Docentes.css" ' Project stylesheet file name
