...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_Log_Docentes Then
			ParentPage = CType(Page, AspNetReportMaker4_Log_Docentes)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_Log_Docentes.crLanguage(New AspNetReportMaker4_Log_Docentes.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
