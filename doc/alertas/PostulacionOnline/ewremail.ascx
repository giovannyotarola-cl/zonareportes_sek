...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_postulacion_online Then
			ParentPage = CType(Page, AspNetReportMaker4_postulacion_online)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_postulacion_online.crLanguage(New AspNetReportMaker4_postulacion_online.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
