...
'
Public Partial Class AspNetReportMaker4_postulacion_online
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "postulacion_online" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "F9EZ3wl%TE7b0k6T" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/postulacion_online.css" ' Project stylesheet file name
	...
	Public Shared EWRPT_DB_CONNECTION_STRING As String = "Persist Security Info=False;Data Source=192.168.100.226;Initial Catalog=CallCenter;User Id=sa;Password=Sa070507"		
