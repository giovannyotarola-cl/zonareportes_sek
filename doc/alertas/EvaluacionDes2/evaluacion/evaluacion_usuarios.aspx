...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="pnlForm">
        ...
        <table class="evaluar_t1 tablaSinBordes">
            <tr>
                <td class="evaluar_t1_cab">Nombre: 
                </td>
            ...
            <tr>
                <td class="evaluar_t1_cab">Periodo de evaluaci&oacute;n:
                </td>
                <td class="evaluar_t1_dato">
            ...
            <tr>
                <td class="evaluar_t1_cab">Fecha de evaluaci&oacute;n:
                </td>
                <td class="evaluar_t1_dato">
        ...
        <table class="evaluar_t2">
            <tr>
                <td colspan="2" class="t2_titulo">RENDIMIENTO LABORAL
                </td>
                <td class="tipo_nota">MUY BUENO
                </td>
                <td class="tipo_nota">BUENO
                </td>
                <td class="tipo_nota">REGULAR
                </td>
                <td class="tipo_nota">INSUFICIENTE
                </td>
                <td class="tipo_nota">DEFICIENTE
                </td>
                <td class="tipo_nota">NOTA
                </td>
            </tr>
            <tr>
                <td class="t2_subcab">a)
                </td>
                <td class="t2_subcab">Calidad
                </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                <td class="t2_subcab">a.1
                </td>
                <td class="t2_pregunta">Trabajos técnicamente correctos y confiables
                </td>
            ...
            <tr>
                <td class="t2_subcab">a.2
                </td>
                <td class="t2_pregunta">Presentaci&oacute;n de los trabajos encargados
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">a.3
                </td>
                <td class="t2_pregunta">Producto generado a través de trabajo de altura a las instrucciones percibidas.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">a.4
                </td>
                <td class="t2_pregunta">Necesidad de Supervisión (incidencia en el trabajo)
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td colspan="5"></td>
                <td colspan="2" class="casilla_subfactor">Promedio Subfactor<br />
                    (a.1 + a.2 + a.3 + a.4) / 4
                </td>
            ...
            <tr>
                <td class="t2_subcab">b)
                </td>
                <td class="t2_subcab">Cantidad y Voluntad
                </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                <td class="t2_subcab">b.1
                </td>
                <td class="t2_pregunta">Capacidad de realizar tareas programadas
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">b.2
                </td>
                <td class="t2_pregunta">Capacidad de realizar tareas no programadas
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">b.3
                </td>
                <td class="t2_pregunta">Iniciativa para enfrentar el trabajo encomendado o para solucionar problemas que se le presentan
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">b.4
                </td>
                <td class="t2_pregunta">Demuestra energía y entusiasmo en el trabajo al que está asignado.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">c)
                </td>
                <td class="t2_subcab">Oportunidad
                </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                <td class="t2_subcab">c.1.
                </td>
                <td class="t2_pregunta">Cumplimiento de plazos en tareas programadas
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">c.2.
                </td>
                <td class="t2_pregunta">Aprovechamiento del tiempo
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">c.3.
                </td>
                <td class="t2_pregunta">Capacidad de organizaci&oacute;n y planificaci&oacute;n.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td class="t2_subcab">c.4.
                </td>
                <td class="t2_pregunta">Se adapta a los requerimientos de fechas planificadas por supervisión de su área.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                <td colspan="5"></td>
                <td colspan="2" class="casilla_subfactor">NOTA FACTOR<br />
            ...
            <tr>
                <td colspan="2" class="t2_titulo">COMPETENCIAS LABORALES
                </td>
                <td class="tipo_nota">MUY BUENO
                </td>
                <td class="tipo_nota">BUENO
                </td>
                <td class="tipo_nota">ACEPTABLE
                </td>
                <td class="tipo_nota">INSUFICIENTE
                </td>
                <td class="tipo_nota">DEFICIENTE
            ...
            <tr>
                ...
                <td class="t2_subcab">Relaciones interpersonales
                </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <td class="t2_pregunta">Disposici&oacute;n para trabajar en equipo
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Comparte con sus pares los conocimientos adquiridos
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Disposici&oacute;n para colaborar con sus compa&ntilde;eros
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Muestra asertividad, empatía, sociabilidad, amabilidad y respeto en el trato con sus pares.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_subcab">Inter&eacute;s por el trabajo y voluntad de servicio
                </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <td class="t2_pregunta">Inter&eacute;s por conocer y aplicar nuevos métodos, técnicas o procedimientos de trabajo.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Inter&eacute;s por asumir mayores responsabilidades.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Flexibilidad y adaptabilidad frente a los cambios.
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Atenci&oacute;n de requerimientos de usuarios
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_subcab">Conocimiento
                </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <td class="t2_pregunta">Grado de aplicac&oacute;n de la informaci&oacute;n
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Calidad de dominio de su trabajo
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Apoyo a sus pares o a la jefatura
                </td>
                <td class="casilla_radio">
            ...
            <tr>
                ...
                <td class="t2_pregunta">Interés por perfeccionarse y mantenerse actualizado en temáticas propias de su disciplina.
                </td>
                <td class="casilla_radio">
        ...
        <asp:Button ID="Button1" runat="server" CssClass="enviar_evaluacion btnInputNuevo"
    ...
    <div class="pnlForm">
        ...
        <ol>
            <li class="aclaracion_item">Al evaluar, conc&eacute;ntrese estrictamente en el periodo que se ha establecido para apreciar el rendimiento del trabajador.
            </li>
            <li class="aclaracion_item">Lea cuidadosamente el significado de los rangos de evaluaci&oacute;n indicados en el cuadro: Rangos de Evaluaci&oacute;n y Puntaje.
            </li>
            <li class="aclaracion_item">H&aacute;gase el prop&oacute;sito de dejar observaciones que faciliten la retroalimentaci&oacute;n del sistema.
            </li>
        </ol>
