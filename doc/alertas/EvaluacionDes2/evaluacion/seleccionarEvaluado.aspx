...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataSourceID="personal_por_evaluar" EmptyDataText= "No hay empleados por evaluar" CssClass="tablaNueva table40Percent">
        <Columns>
    ...
    <asp:GridView ID="grilla_evaluados" runat="server" AutoGenerateColumns="False" 
        DataSourceID="personal_evaluado" EmptyDataText= "No hay empleados evaluados" BorderColor="Transparent" CssClass="tablaNueva table60Percent">
        <Columns>
            <asp:BoundField DataField="id" HeaderText="Id" Visible="False" />
            <asp:TemplateField HeaderText="Empleado">
                <ItemTemplate>
      ...
      <br />
        ...
        <asp:DropDownList ID="ddlPeriodos_EvRec" runat="server" AutoPostBack="True" 
            DataSourceID="sqlPeriodosEvaluado" DataTextField="Periodo" DataValueField="Periodo"></asp:DropDownList>
        </div>
    <asp:GridView ID="grilla_ev_recibidas" runat="server" AutoGenerateColumns="False" 
        DataSourceID="evaluaciones_recibidas" EmptyDataText= "No se han recibido evaluaciones" BorderColor="Transparent" CssClass="tablaNueva table50Percent">
        <Columns>
            <asp:BoundField DataField="id" HeaderText="Id" Visible="False" />
    ...
    <asp:SqlDataSource ID="sqlPeriodosEvaluado" runat="server" 
            ConnectionString="<%$ ConnectionStrings:cadenaConexion %>">
            <SelectParameters>
                <asp:SessionParameter Name="id" SessionField="user_id" />
            </SelectParameters>
