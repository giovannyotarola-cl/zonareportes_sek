...
Public Class evaluacion_usuarios
    ...
    Protected Sub fillEmpleado(ByVal evaluado As String)
        ...
        Try
            strSQL = "select * from dbo.SEK_EvDes_Users where id = " + evaluado + ";"
            ...
            da.Fill(ds)
            nombre_evaluado = ds.Tables(0).Rows(0)("nombre").ToString()
            cargo_evaluado = ds.Tables(0).Rows(0)("cargo").ToString()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            SQLInsert = "Insert into dbo.SEK_EvDes_Encuesta (id_evaluador, id_empleado, fecha, estado, ano, semestre, aceptada, G1_a1, G1_a2, G1_a3,G1_a4, G1_a, G1_b1, G1_b2, G1_b3, G1_b4, G1_b, G1_c1, G1_c2, G1_c3, G1_c4, G1_c, G2_a1, G2_a2, G2_a3, G2_a4, G2_a, G2_b1, G2_b2, G2_b3, G2_b4, G2_b, G2_c1, G2_c2, G2_c3, G2_c4, G2_c, G1_promedio, G2_promedio, observaciones, compromiso_mejora) values ('" + Session("user_id").ToString + "', '" + id_empleado.Value.ToString + "', '" + DateTime.Now.ToString("dd-MM-yyyy H:mm:ss") + "', '1', '" + Session("ano").ToString + "', '" + Session("semestre").ToString + "', -1, '" + Request.Form("g1_a1").ToString + "', '" + Request.Form("g1_a2").ToString + "', '" + Request.Form("g1_a3").ToString + "', '" + Request.Form("g1_a4").ToString + "', '" + Request.Form("ctl00$MainContent$g1_a_nota").ToString + "', '" + Request.Form("g1_b1").ToString + "', '" + Request.Form("g1_b2").ToString + "', '" + Request.Form("g1_b3").ToString + "', '" + Request.Form("g1_b4").ToString + "', '" + Request.Form("ctl00$MainContent$g1_b_nota").ToString + "', '" + Request.Form("g1_c1").ToString + "', '" + Request.Form("g1_c2").ToString + "', '" + Request.Form("g1_c3").ToString + "', '" + Request.Form("g1_c4").ToString + "', '" + Request.Form("ctl00$MainContent$g1_c_nota").ToString + "', '" + Request.Form("g2_a1").ToString + "', '" + Request.Form("g2_a2").ToString + "', '" + Request.Form("g2_a3").ToString + "', '" + Request.Form("g2_a4").ToString + "', '" + Request.Form("ctl00$MainContent$g2_a_nota").ToString + "', '" + Request.Form("g2_b1").ToString + "', '" + Request.Form("g2_b2").ToString + "', '" + Request.Form("g2_b3").ToString + "', '" + Request.Form("g2_b4").ToString + "', '" + Request.Form("ctl00$MainContent$g2_b_nota").ToString + "', '" + Request.Form("g2_c1").ToString + "', '" + Request.Form("g2_c2").ToString + "', '" + Request.Form("g2_c3").ToString + "', '" + Request.Form("g2_c4").ToString + "', '" + Request.Form("ctl00$MainContent$g2_c_nota").ToString + "', '" + Request.Form("ctl00$MainContent$g1_nota").ToString + "', '" + Request.Form("ctl00$MainContent$g2_nota").ToString + "', '" + Request.Form("ctl00$MainContent$observaciones").ToString + "', '" + Request.Form("ctl00$MainContent$compromiso_mejora").ToString + "')"
        ...
        Catch ex As Exception
            System.Diagnostics.Debug.WriteLine("Error es: " + ex.Message)
        Finally
            conn.Close()
        End Try
