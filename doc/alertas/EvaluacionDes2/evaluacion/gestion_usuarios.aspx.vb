Public Class gestion_usuarios
    ...
    Protected Sub confirm_delete(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grilla_usuarios.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim db As LinkButton
            db = e.Row.Cells(8).Controls(2)
            ...
            If Right(e.Row.Cells(8).Controls(2).UniqueID, 1) = 1 Then
                db.OnClientClick = "return confirm('¿Está seguro de querer borrar el usuario seleccionado?');"
            End If
        End If
    End Sub

    Protected Sub actualizar_tabla_usuarios(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewInsertedEventArgs) Handles FormView1.ItemInserted
