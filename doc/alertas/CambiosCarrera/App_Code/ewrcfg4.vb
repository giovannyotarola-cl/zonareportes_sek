...
'
Public Partial Class AspNetReportMaker4_CambiosCarrera
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "CambiosCarrera" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "KP6TI3T6yyc6ngu_" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/CambiosCarrera.css" ' Project stylesheet file name
