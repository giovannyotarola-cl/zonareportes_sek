...
'
Public Partial Class AspNetReportMaker4_compromisosPago
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "compromisosPago" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "3K38Oc_woyk1Bm#Y" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/compromisosPago.css" ' Project stylesheet file name
