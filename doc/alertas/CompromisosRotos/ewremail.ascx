...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_compromisosPago Then
			ParentPage = CType(Page, AspNetReportMaker4_compromisosPago)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_compromisosPago.crLanguage(New AspNetReportMaker4_compromisosPago.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
