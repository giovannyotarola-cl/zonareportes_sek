...
Public Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Global_Area.SelectCommand = "SELECT DISTINCT dbo.SEK_V_PermisosArea.name_area AS AREA, dbo.V_SEK_DimensionArea.Name FROM dbo.SEK_V_PermisosArea INNER JOIN dbo.V_SEK_DimensionArea ON dbo.SEK_V_PermisosArea.name_area = dbo.V_SEK_DimensionArea.Code WHERE (dbo.SEK_V_PermisosArea.username = '" + Session("username") + "')"
        Global_Sede.SelectCommand = "SELECT DISTINCT dbo.SEK_V_PermisosSede.name_sede AS SEDE, dbo.V_SEK_DimensionSede.Name FROM dbo.SEK_V_PermisosSede INNER JOIN dbo.V_SEK_DimensionSede ON dbo.SEK_V_PermisosSede.name_sede = dbo.V_SEK_DimensionSede.Code WHERE (dbo.SEK_V_PermisosSede.username = '" + Session("username") + "')"
