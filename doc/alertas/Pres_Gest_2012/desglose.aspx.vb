...
Public Class WebForm1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("mes") <> "" Then
            ...
            CheckFill_AreaMes.SelectCommand = "SELECT DISTINCT dbo.SEK_V_PermisosArea.name_area AS AREA, dbo.V_SEK_DimensionArea.Name FROM dbo.SEK_V_PermisosArea INNER JOIN dbo.V_SEK_DimensionArea ON dbo.SEK_V_PermisosArea.name_area = dbo.V_SEK_DimensionArea.Code INNER JOIN dbo.SEK_Presupuestos_Users on dbo.SEK_V_PermisosArea.user_id=dbo.SEK_Presupuestos_Users.id where (SEK_Presupuestos_Users.username= '" + Session("username") + "')"
            CheckFill_SedeMes.SelectCommand = "SELECT DISTINCT dbo.SEK_V_PermisosSede.name_sede AS SEDE, dbo.V_SEK_DimensionSede.Name FROM dbo.SEK_V_PermisosSede INNER JOIN dbo.V_SEK_DimensionSede ON dbo.SEK_V_PermisosSede.name_sede = dbo.V_SEK_DimensionSede.Code"
        Else
            ...
            CheckFill_Area.SelectCommand = "SELECT DISTINCT dbo.SEK_V_PermisosArea.name_area AS AREA, dbo.V_SEK_DimensionArea.Name FROM dbo.SEK_V_PermisosArea INNER JOIN dbo.V_SEK_DimensionArea ON dbo.SEK_V_PermisosArea.name_area = dbo.V_SEK_DimensionArea.Code INNER JOIN dbo.SEK_Presupuestos_Users on dbo.SEK_V_PermisosArea.user_id=dbo.SEK_Presupuestos_Users.id where (SEK_Presupuestos_Users.username= '" + Session("username") + "')"
            CheckFill_Sede.SelectCommand = "SELECT DISTINCT dbo.SEK_V_PermisosSede.name_sede AS SEDE, dbo.V_SEK_DimensionSede.Name FROM dbo.SEK_V_PermisosSede INNER JOIN dbo.V_SEK_DimensionSede ON dbo.SEK_V_PermisosSede.name_sede = dbo.V_SEK_DimensionSede.Code"
        End If
