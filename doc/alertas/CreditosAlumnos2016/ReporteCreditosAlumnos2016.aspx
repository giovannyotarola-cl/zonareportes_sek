<%@ Page Title="Reporte" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ReporteCreditosAlumnos2016.aspx.vb" Inherits="AlumnosConvalidados" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h3>REPORTE CREDITOS ALUMNOS 2016</h3>
    <table>
        <tbody>
            <tr class="inter">
                <td class="cell-border">RUT</td>
                <td>
    ...
    <div id="data-result" class="content-arancel">
        <asp:Table ID="tblCreditosAlumnos2016" runat="server" CssClass="display font9 dataTable">
            <asp:tableHEaderRow ID="TableHEaderRow1" TableSection="TableHeader" runat="server">
                ...
                <asp:TableHeaderCell>PLAN DE ESTUDIO</asp:TableHeaderCell>
                ...
                <asp:TableHeaderCell>CRÉDITOS INSCRITOS 2016</asp:TableHeaderCell>
                <asp:TableHeaderCell>CRÉDITOS APROBADOS 2016</asp:TableHeaderCell>
                <asp:TableHeaderCell>TOTAL CRÉDITOS INSCRITOS</asp:TableHeaderCell>
                <asp:TableHeaderCell>TOTAL CRÉDITOS APROBADOS</asp:TableHeaderCell>
            </asp:tableHEaderRow>
        </asp:Table>
    </div>
    <script>
