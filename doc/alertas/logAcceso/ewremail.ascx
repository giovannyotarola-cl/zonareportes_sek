...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_logAcceso Then
			ParentPage = CType(Page, AspNetReportMaker4_logAcceso)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_logAcceso.crLanguage(New AspNetReportMaker4_logAcceso.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
