...
'
Public Partial Class AspNetReportMaker4_logAcceso
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "logAcceso" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "v%bcT4sWiN2UH#_B" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/logAcceso.css" ' Project stylesheet file name
