...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_gestionCobranza Then
			ParentPage = CType(Page, AspNetReportMaker4_gestionCobranza)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_gestionCobranza.crLanguage(New AspNetReportMaker4_gestionCobranza.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
