...
'
Public Partial Class AspNetReportMaker4_gestionCobranza
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "gestionCobranza" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "R20_n325A%6g_gkf" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/gestionCobranza.css" ' Project stylesheet file name
