...
if (elm && !ewrpt_CheckEuroDate(elm.value)) {
	if (!ewrpt_OnError(elm, "Incorrect date, format = dd/mm/yyyy - FECHA DE MATRICULA"))
		return false;
}
...
<% End If %>
<div id="underline">
	<h1>Detalle Reporte Autoevaluaci&oacute;n</h1>
</div>
<% If sExport = "" Then %>
...
<input type="text" name="sv1_fecmat" id="sv1_fecmat" value="<%= Server.HTMLEncode(sv1_fecmat&"") %>"<%= sClearInputClass %>>
				...
				<td><span class="ewRptSearchOpr" id="btw1_fecmat" name="btw1_fecmat">&nbsp;y&nbsp;</span></td>
