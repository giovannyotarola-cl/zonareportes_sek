...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_encuesta_jefecarrera Then
			ParentPage = CType(Page, AspNetReportMaker4_encuesta_jefecarrera)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_encuesta_jefecarrera.crLanguage(New AspNetReportMaker4_encuesta_jefecarrera.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
