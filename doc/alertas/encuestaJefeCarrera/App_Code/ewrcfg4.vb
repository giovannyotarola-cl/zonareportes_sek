...
Public Partial Class AspNetReportMaker4_encuesta_jefecarrera
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "encuesta_jefecarrera" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "38D93a88GMm9LgHV" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/encuesta_jefecarrera.css" ' Project stylesheet file name
