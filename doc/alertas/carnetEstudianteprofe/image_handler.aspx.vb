...
Public Class image_handler
    ...
    Protected Sub CreateImage(ByVal id_alumno As String)
        ...
        strSQL = "SELECT FOTO from [Foto_Alumno] WHERE CODCLI = '" + id_alumno + "';"
        'System.Diagnostics.Debug.WriteLine(strSQL)

        conn = New SqlConnection()
        conn.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("Matricula").ConnectionString
        conn.Open()
