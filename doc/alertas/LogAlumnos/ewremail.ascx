...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_LogAlumnos Then
			ParentPage = CType(Page, AspNetReportMaker4_LogAlumnos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_LogAlumnos.crLanguage(New AspNetReportMaker4_LogAlumnos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
