...
'
Public Partial Class AspNetReportMaker4_LogAlumnos
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "LogAlumnos" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "1L&VyhGUAn7s06T&" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/LogAlumnos.css" ' Project stylesheet file name
