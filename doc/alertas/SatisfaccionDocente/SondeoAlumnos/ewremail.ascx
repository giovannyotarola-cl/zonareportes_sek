...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_SondeoAlumnos Then
			ParentPage = CType(Page, AspNetReportMaker4_SondeoAlumnos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_SondeoAlumnos.crLanguage(New AspNetReportMaker4_SondeoAlumnos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
