...
Public Partial Class AspNetReportMaker4_SondeoAlumnos
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "SondeoAlumnos" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "_mAa4bB#ShQezSi0" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/SondeoAlumnos.css" ' Project stylesheet file name
