...
'
Public Partial Class AspNetReportMaker4_encuesta_docente_satisfaccion
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "encuesta_docente_satisfaccion" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "xJ_Lr6&2lrFj0WZy" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/encuesta_docente_satisfaccion.css" ' Project stylesheet file name
