...
'
Public Partial Class AspNetReportMaker4_EstadoAlumnosGlobal
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "EstadoAlumnosGlobal" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "2l59T44q6NQaTE%2" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/EstadoAlumnosGlobal.css" ' Project stylesheet file name
