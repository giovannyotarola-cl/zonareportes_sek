...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_EstadoAlumnosGlobal Then
			ParentPage = CType(Page, AspNetReportMaker4_EstadoAlumnosGlobal)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_EstadoAlumnosGlobal.crLanguage(New AspNetReportMaker4_EstadoAlumnosGlobal.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
