...
Public Partial Class AspNetReportMaker4_EncuestaDocenteAlumnos
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "EncuestaDocenteAlumnos" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "jSkIv#7t1%87Ztbq" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/EncuestaDocenteAlumnos.css" ' Project stylesheet file name
