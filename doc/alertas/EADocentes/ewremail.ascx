...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_EncuestaDocenteAlumnos Then
			ParentPage = CType(Page, AspNetReportMaker4_EncuestaDocenteAlumnos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_EncuestaDocenteAlumnos.crLanguage(New AspNetReportMaker4_EncuestaDocenteAlumnos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
