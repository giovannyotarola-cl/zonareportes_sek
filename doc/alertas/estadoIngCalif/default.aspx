<%@ Page ClassName="_default" Language="VB" MasterPageFile="rmasterpage.master" Inherits="AspNetReportMaker4_estadoIngresoCalificaciones_Chile" %>
...
<script runat="server">
	...
	' Page object
	Public rptdefault As crrptdefault

	'
	' Page class
	'
	Public Class crrptdefault
		...
		Public Sub Page_Main()
			Page_Terminate("Estado_ingreso_calificacionessmry.aspx")
		End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		...
		' Page init
		rptdefault = New crrptdefault(Me)
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) 
		...
		' Dispose page object
		If (rptdefault IsNot Nothing) Then rptdefault.Dispose()
	End Sub
</script>
