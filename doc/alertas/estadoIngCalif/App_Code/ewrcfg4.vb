...
'
Public Partial Class AspNetReportMaker4_estadoIngresoCalificaciones_Chile
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "estadoIngresoCalificaciones_Chile" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "B0mtV5swJ_GQ&4FT" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/estadoIngresoCalificaciones_Chile.css" ' Project stylesheet file name
	...
	Public Shared EWRPT_DB_CONNECTION_STRING As String = "Persist Security Info=False;Data Source=192.168.100.226;Initial Catalog=Matricula;User Id=matricula;Password=dtb01s"		
