...
Const EW_REPORT_RANDOM_KEY = "f9gE5n6In0pG3lJ%" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "historicoreprobados" ' Project Name
Const EW_REPORT_PROJECT_VAR = "historicoreprobados" ' Project Var
