...
Public Partial Class AspNetReportMaker4_CVTotal_2
	...
	Public Const EWRPT_RANDOM_KEY As String = "Ok4263epV0oyK4s9" ' Random key for encryption
	...
	Public Shared EWRPT_DB_CONNECTION_STRING As String = "Persist Security Info=False;Data Source=192.168.30.250;Initial Catalog=Matricula;User Id=matricula;Password=dtb01s"		
