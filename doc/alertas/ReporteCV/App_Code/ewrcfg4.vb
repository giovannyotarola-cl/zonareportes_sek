...
'
Public Partial Class AspNetReportMaker4_CVTotal_2
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "CVTotal_2" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "Z497c1KhI#oHW9_k" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/CVTotal_2.css" ' Project stylesheet file name
