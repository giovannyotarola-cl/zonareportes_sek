...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_dicomBajarPagareGarantia Then
			ParentPage = CType(Page, AspNetReportMaker4_dicomBajarPagareGarantia)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_dicomBajarPagareGarantia.crLanguage(New AspNetReportMaker4_dicomBajarPagareGarantia.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
