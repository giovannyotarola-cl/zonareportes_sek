...
Public Partial Class AspNetReportMaker4_dicomBajarPagareGarantia
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "dicomBajarPagareGarantia" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "VFNgC#i5O1_74C7_" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/dicomBajarPagareGarantia.css" ' Project stylesheet file name
