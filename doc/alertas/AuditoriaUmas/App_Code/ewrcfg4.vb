...
'
Public Partial Class AspNetReportMaker4_AuditoriaUmas
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "AuditoriaUmas" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "3hxpG1H9imbA2X&W" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/AuditoriaUmas.css" ' Project stylesheet file name
