...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_AuditoriaUmas Then
			ParentPage = CType(Page, AspNetReportMaker4_AuditoriaUmas)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_AuditoriaUmas.crLanguage(New AspNetReportMaker4_AuditoriaUmas.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
