...
Public Partial Class AspNetReportMaker4_postul_cae_2012
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "postul_cae_2012" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "F9pmZessSWD_fL4Y" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/postul_cae_2012.css" ' Project stylesheet file name
