...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_asignaturasPlanProfesor_Chile Then
			ParentPage = CType(Page, AspNetReportMaker4_asignaturasPlanProfesor_Chile)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_asignaturasPlanProfesor_Chile.crLanguage(New AspNetReportMaker4_asignaturasPlanProfesor_Chile.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
