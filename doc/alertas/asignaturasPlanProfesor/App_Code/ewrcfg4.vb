...
Public Partial Class AspNetReportMaker4_asignaturasPlanProfesor_Chile
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "asignaturasPlanProfesor_Chile" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "1&y&%wIkA24G#EJC" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/asignaturasPlanProfesor_Chile.css" ' Project stylesheet file name
