...
Public Partial Class AspNetReportMaker4_postergados
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "postergados" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "QP66ZI#1wzKrzbb3" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/postergados.css" ' Project stylesheet file name
