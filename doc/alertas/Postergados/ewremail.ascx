...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_postergados Then
			ParentPage = CType(Page, AspNetReportMaker4_postergados)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_postergados.crLanguage(New AspNetReportMaker4_postergados.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
