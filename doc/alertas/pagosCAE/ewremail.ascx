...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_PagoCAE Then
			ParentPage = CType(Page, AspNetReportMaker4_PagoCAE)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_PagoCAE.crLanguage(New AspNetReportMaker4_PagoCAE.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
