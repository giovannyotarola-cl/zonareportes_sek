...
'
Public Partial Class AspNetReportMaker4_PagoCAE
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "PagoCAE" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "_bmrcD0wNn&TxF#Y" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/PagoCAE.css" ' Project stylesheet file name
