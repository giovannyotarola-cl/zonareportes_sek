...
Const EW_REPORT_RANDOM_KEY = "EGNGQvIpEMUk#h9$" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "Alumnosindoc" ' Project Name
Const EW_REPORT_PROJECT_VAR = "Alumnosindoc" ' Project Var
