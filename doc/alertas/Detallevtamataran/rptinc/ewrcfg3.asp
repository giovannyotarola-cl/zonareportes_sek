...
Const EW_REPORT_RANDOM_KEY = "mK%4p#$F9cBzHB4&" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "Detallevtamataran" ' Project Name
Const EW_REPORT_PROJECT_VAR = "Detallevtamataran" ' Project Var
