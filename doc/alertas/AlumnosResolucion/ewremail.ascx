...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_AlumnosResolucion Then
			ParentPage = CType(Page, AspNetReportMaker4_AlumnosResolucion)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_AlumnosResolucion.crLanguage(New AspNetReportMaker4_AlumnosResolucion.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
