...
'
Public Partial Class AspNetReportMaker4_AlumnosResolucion
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "AlumnosResolucion" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "Hft6#9MIZak4kwbC" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/AlumnosResolucion.css" ' Project stylesheet file name
