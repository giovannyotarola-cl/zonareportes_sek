...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_CVTotal Then
			ParentPage = CType(Page, AspNetReportMaker4_CVTotal)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_CVTotal.crLanguage(New AspNetReportMaker4_CVTotal.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
