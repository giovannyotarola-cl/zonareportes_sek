...
'
Public Partial Class AspNetReportMaker4_CVTotal
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "CVTotal" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "1dZg1I6eBvigG5c1" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/CVTotal.css" ' Project stylesheet file name
