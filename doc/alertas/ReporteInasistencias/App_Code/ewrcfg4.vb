...
Public Partial Class AspNetReportMaker4_AlertasInasistencias
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "AlertasInasistencias" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "nY4uvH5%fJMviQ84" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/AlertasInasistencias.css" ' Project stylesheet file name
