...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_AlertasInasistencias Then
			ParentPage = CType(Page, AspNetReportMaker4_AlertasInasistencias)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_AlertasInasistencias.crLanguage(New AspNetReportMaker4_AlertasInasistencias.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
