...
Const EW_REPORT_RANDOM_KEY = "qUj$YZ72T#A#&5QJ" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "Morosos" ' Project Name
Const EW_REPORT_PROJECT_VAR = "Morosos" ' Project Var
