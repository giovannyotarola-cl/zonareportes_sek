...
'
Public Partial Class AspNetReportMaker4_E_Percepcion
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "E_Percepcion" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "6m59hrHMpfMY_5%4" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/E_Percepcion.css" ' Project stylesheet file name
