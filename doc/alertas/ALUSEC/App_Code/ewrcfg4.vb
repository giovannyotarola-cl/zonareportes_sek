...
'
Public Partial Class AspNetReportMaker4_Alumnos_Lista_Clase
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "Alumnos_Lista_Clase" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "_KOm9HdS302khdLU" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/Alumnos_Lista_Clase.css" ' Project stylesheet file name
