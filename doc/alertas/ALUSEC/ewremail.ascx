...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_Alumnos_Lista_Clase Then
			ParentPage = CType(Page, AspNetReportMaker4_Alumnos_Lista_Clase)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_Alumnos_Lista_Clase.crLanguage(New AspNetReportMaker4_Alumnos_Lista_Clase.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
