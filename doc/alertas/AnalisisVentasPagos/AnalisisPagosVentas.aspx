<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="AnalisisPagosVentas.aspx.vb" Inherits="AnalisisPagosVentas" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" Runat="Server">

    <h3>REPORTE VENTAS PAGOS</h3>
    <table>
        <tbody>
            <tr class="inter">
    ...
    <div id="data-result" class="content-arancel">
        <asp:Table ID="TBL_Alumnos" runat="server" CssClass="display">
            <asp:tableHEaderRow ID="TableHEaderRow1" TableSection="TableHeader" runat="server">
                <asp:TableHeaderCell>NÚMERO PAGARE</asp:TableHeaderCell>
                <asp:TableHeaderCell>RUT</asp:TableHeaderCell>
                <asp:TableHeaderCell>DIG</asp:TableHeaderCell>
                <asp:TableHeaderCell>CODCARR</asp:TableHeaderCell>
                ...
                <asp:TableHeaderCell>MAIL</asp:TableHeaderCell>
                ...
                <asp:TableHeaderCell>TELÉFONO PROCEDENCIA</asp:TableHeaderCell>
                <asp:TableHeaderCell>TELÉFONO ACTIVO</asp:TableHeaderCell>
                <asp:TableHeaderCell>CÓDIGO FACULTAD</asp:TableHeaderCell>
                <asp:TableHeaderCell>FACULTAD</asp:TableHeaderCell>
                <asp:TableHeaderCell>CÓDIGO DOCUMENTO</asp:TableHeaderCell>
                ...
                <asp:TableHeaderCell>NÚMERO DE CUOTAS</asp:TableHeaderCell>
                <asp:TableHeaderCell>MONTO</asp:TableHeaderCell>
                <asp:TableHeaderCell>SALDO</asp:TableHeaderCell>
                <asp:TableHeaderCell>FECHA DEUDA</asp:TableHeaderCell>
                <asp:TableHeaderCell>ESTADO ACADÉMICO</asp:TableHeaderCell>
                <asp:TableHeaderCell>TIPO SITUACIÓN</asp:TableHeaderCell>
                <asp:TableHeaderCell>SITUACIÓN</asp:TableHeaderCell>
                <asp:TableHeaderCell>AÑO MATRICULA</asp:TableHeaderCell>
                <asp:TableHeaderCell>SEDE</asp:TableHeaderCell>
                <asp:TableHeaderCell>CODIGO PAGO</asp:TableHeaderCell>
                <asp:TableHeaderCell>TIPO PAGO</asp:TableHeaderCell>
                <asp:TableHeaderCell>NUMERO PAGO</asp:TableHeaderCell>
                <asp:TableHeaderCell>MONTO PAGO</asp:TableHeaderCell>
            </asp:tableHEaderRow>
        </asp:Table>
    </div>
    <script>
