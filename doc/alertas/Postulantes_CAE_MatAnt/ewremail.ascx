...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_postul_cae_2012_mat_anterior Then
			ParentPage = CType(Page, AspNetReportMaker4_postul_cae_2012_mat_anterior)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_postul_cae_2012_mat_anterior.crLanguage(New AspNetReportMaker4_postul_cae_2012_mat_anterior.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
