...
Public Partial Class AspNetReportMaker4_postul_cae_2012_mat_anterior
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "postul_cae_2012_mat_anterior" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "IG59Q%rd#n#T2Yw4" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/postul_cae_2012_mat_anterior.css" ' Project stylesheet file name
