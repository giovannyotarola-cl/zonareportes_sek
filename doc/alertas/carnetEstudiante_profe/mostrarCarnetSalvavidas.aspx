...
AND  A.CODPROF = @alumno UNION 
SELECT (CR.NOMBRE +' ' + CR.PATERNO + ' ' +CR.MATERNO) AS NOMBRE ,CR.RUT,CR.RUT AS cedula , case when cr.C_MAT= 'SCOBSD' then 'OBSTETRICIA Y NEONATOLOGIA' END as Carrera FROM SEK_CREDENCIALES CR WHERE RUT=@alumno">
        <SelectParameters>
