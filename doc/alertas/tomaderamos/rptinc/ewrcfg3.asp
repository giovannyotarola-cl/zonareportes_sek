...
Const EW_REPORT_RANDOM_KEY = "Y7b9Uy10R&1niVm4" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "Tomaderamos" ' Project Name
Const EW_REPORT_PROJECT_VAR = "Tomaderamos" ' Project Var
