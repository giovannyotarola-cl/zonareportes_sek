...
<td class="ewTableHeader">
<% If (ew_NotEmpty(Total_Matriculados.Export)) Then %>
<%= Total_Matriculados.MODALIDAD.FldCaption() %>
<% Else %>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<% If (ew_Empty(Total_Matriculados.SortUrl(Total_Matriculados.MODALIDAD))) Then %>
		<td style="vertical-align: bottom;"><%= Total_Matriculados.MODALIDAD.FldCaption() %></td>
<% Else %>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<%= Total_Matriculados.SortUrl(Total_Matriculados.MODALIDAD) %>',0);"><%= Total_Matriculados.MODALIDAD.FldCaption() %></td><td style="width: 10px;">
		<% If (Total_Matriculados.MODALIDAD.Sort = "ASC") Then %><img src="aspxrptimages/sortup.gif" width="10" height="9" border="0"><% ElseIf (Total_Matriculados.MODALIDAD.Sort = "DESC") Then %><img src="aspxrptimages/sortdown.gif" width="10" height="9" border="0"><% End If %></td>
<% End If %>
	</tr></table>
<% End If %>
</td>
...
<td class="ewTableHeader">
<% If (ew_NotEmpty(Total_Matriculados.Export)) Then %>
<%= Total_Matriculados.CATEGORIA.FldCaption() %>
<% Else %>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<% If (ew_Empty(Total_Matriculados.SortUrl(Total_Matriculados.CATEGORIA))) Then %>
		<td style="vertical-align: bottom;"><%= Total_Matriculados.CATEGORIA.FldCaption() %></td>
<% Else %>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<%= Total_Matriculados.SortUrl(Total_Matriculados.CATEGORIA) %>',0);"><%= Total_Matriculados.CATEGORIA.FldCaption() %></td><td style="width: 10px;">
		<% If (Total_Matriculados.CATEGORIA.Sort = "ASC") Then %><img src="aspxrptimages/sortup.gif" width="10" height="9" border="0"><% ElseIf (Total_Matriculados.CATEGORIA.Sort = "DESC") Then %><img src="aspxrptimages/sortdown.gif" width="10" height="9" border="0"><% End If %></td>
<% End If %>
	</tr></table>
<% End If %>
</td>
