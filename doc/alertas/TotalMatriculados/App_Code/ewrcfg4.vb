...
'
Public Partial Class AspNetReportMaker4_TotalMatriculados
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "TotalMatriculados" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "37RR&08r3%D7dk5s" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/TotalMatriculados.css" ' Project stylesheet file name
