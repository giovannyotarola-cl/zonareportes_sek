...
Const EW_REPORT_RANDOM_KEY = "12Vja%hNxp$PB1Z2" ' Random key for encryption
...
' Session names
Const EW_REPORT_PROJECT_NAME = "ResumenDocpag" ' Project Name
Const EW_REPORT_PROJECT_VAR = "ResumenDocpag" ' Project Var
