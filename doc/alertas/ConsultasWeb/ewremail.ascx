...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_consultasWeb Then
			ParentPage = CType(Page, AspNetReportMaker4_consultasWeb)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_consultasWeb.crLanguage(New AspNetReportMaker4_consultasWeb.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
