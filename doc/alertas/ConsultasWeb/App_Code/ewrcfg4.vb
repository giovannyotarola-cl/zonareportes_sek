...
'
Public Partial Class AspNetReportMaker4_consultasWeb
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "consultasWeb" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "&9NVNtKVbn7EVH&O" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/consultasWeb.css" ' Project stylesheet file name
