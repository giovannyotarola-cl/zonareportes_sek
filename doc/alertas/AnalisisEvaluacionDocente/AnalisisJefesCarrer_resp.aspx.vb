...
Partial Class _Default
    ...
    Protected Sub cargarCarreras(ByVal codFac As String)
        ...
        Dim strSql As String = "select codcarr,nombre_c,jornada from dbo.mt_carrer where codfac IN('" + codFac + "') and tipocarr IN(1,4) group by codcarr,nombre_c,jornada"
            ...
            Try
                ...
                If (dsAsignaturas.Tables(0).Rows.Count > 0) Then
                    For i As Integer = 0 To dsAsignaturas.Tables(0).Rows.Count - 1
                        ...
                        CellPromProfesor.Text = Mid(calculaPromedioGeneral(codProfST, anioST, periodoST, ramoST), 1, 4)
    ...
    Protected Function calculaPromedioGeneral(ByVal codprof As String, ByVal anio As String, ByVal periodo As String, ByVal codramo As String) As String
