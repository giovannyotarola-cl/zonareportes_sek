<%@ Page Title="Evaluación Jefe de Carrera" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="mostrarJefeCarreraPE.aspx.vb" Inherits="mostrarEvEstudianteDocente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="tablaInforme">
        <tbody>
            ...
            <tr>
                <td><span>1. </span>Cumple con las funciones que la Unidad Académica le asigna (planificar, calendarizar, revisiones bibliográficas...)</td>
                <td><asp:Label ID="lblEvaluacion1" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblEvaluacion1Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>2. </span>Mantiene actualizada oportunamente su asignatura en moodle</td>
            ...
            <tr>
                <td><span>1. </span>Entrega planificación de aprendizaje de sus clases</td>
            ...
            <tr>
                <td><span>1. </span>Establece una relación cordial y de respeto con los estudiantes.</td>
                <td><asp:Label ID="lblClima1" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblClima1Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>2. </span>Se preocupa de responder las dudas e inquietudes que le plantean los estudiantes en clases.</td>
                <td><asp:Label ID="lblClima2" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblClima2Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>3. </span>En clases mantiene una comunicación clara, sensible y empática con los estudiantes.</td>
