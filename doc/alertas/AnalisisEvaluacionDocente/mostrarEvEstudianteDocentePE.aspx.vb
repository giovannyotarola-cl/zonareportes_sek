...
Partial Class mostrarEvEstudianteDocentePE
    ...
    Protected Sub btnGuardarCompromiso_Click(sender As Object, e As EventArgs) Handles btnGuardarCompromiso.Click

        'Response.Redirect("Account/Login.aspx")

        Dim asignatura_com As String = Request.QueryString("ASIGNATURA")
        Dim profesor_com As String = Request.QueryString("PROFESOR")
        Dim ano_com As String = Request.QueryString("ANO")
        Dim periodo_com As String = Request.QueryString("PERIODO")
        Dim seccion_com As String = Request.QueryString("SECCION")
        Dim carrera_com As String = Request.QueryString("CARRERA")
        Dim observacion As String = txt_observacion.Text
        ...
        '		Dim strSql As String = "insert into SEK_AnalisisEncuestaDocentesCompromiso values ('123','afvgb','2018','1','1','carre','hola')"
        Dim strSql As String = "insert into SEK_AnalisisEncuestaDocentesCompromiso values ('" + profesor_com + "','" + asignatura_com + "','" + ano_com + "','" + periodo_com + "','" + seccion_com + "','" + carrera_com + "','" + observacion + "')"
        ...
        Catch ex As Exception
            ...
            Response.Write("Error al guardar compromiso")
        Finally
            conn.Close()
        End Try
    ...
    Protected Sub cargarEncuestaProfe()
        ...
        Dim strSql As String = "select " +
            " AVG(CAST(P1 AS DECIMAL)) AS P1" +
            ",AVG(CAST(P2 AS DECIMAL)) AS P2" +
            ",AVG(CAST(P3 AS DECIMAL)) AS P3" +
            ",AVG(CAST(P4 AS DECIMAL)) AS P4" +
            ",AVG(CAST(P5 AS DECIMAL)) AS P5" +
            ",AVG(CAST(P6 AS DECIMAL)) AS P6" +
            ",AVG(CAST(P7 AS DECIMAL)) AS P7" +
            ",AVG(CAST(P8 AS DECIMAL)) AS P8" +
            ",AVG(CAST(P9 AS DECIMAL)) AS P9" +
            ",AVG(CAST(P10 AS DECIMAL)) AS P10" +
            ",AVG(CAST(P11 AS DECIMAL)) AS P11" +
            ",AVG(CAST(P12 AS DECIMAL)) AS P12" +
            ",AVG(CAST(P13 AS DECIMAL)) AS P13" +
            ",AVG(CAST(P14 AS DECIMAL)) AS P14" +
            ",AVG(CAST(P15 AS DECIMAL)) AS P15" +
            ",AVG(CAST(P16 AS DECIMAL)) AS P16" +
            ",AVG(CAST(P17 AS DECIMAL)) AS P17" +
            ",AVG(CAST(P18 AS DECIMAL)) AS P18" +
            ",AVG(CAST(P19 AS DECIMAL)) AS P19" +
            ",AVG(CAST(P20 AS DECIMAL)) AS P20" +
            ",AVG(CAST(P21 AS DECIMAL)) AS P21" +
            ",AVG(CAST(P22 AS DECIMAL)) AS P22" +
            ",AVG(CAST(P23 AS DECIMAL)) AS P23" +
            ",AVG(CAST(P24 AS DECIMAL)) AS P24" +
            ",AVG(CAST(P25 AS DECIMAL)) AS P25" +
            ",AVG(CAST(P26 AS DECIMAL)) AS P26" +
            ",AVG((CAST(P1 AS DECIMAL) + CAST(P2 AS DECIMAL) + CAST(P3 AS DECIMAL) + CAST(P4 AS DECIMAL))/4) AS PromPlaneacion" +
            ",AVG((CAST(P5 AS DECIMAL) + CAST(P6 AS DECIMAL) + CAST(P7 AS DECIMAL) + CAST(P8 AS DECIMAL))/4) AS PromMetodologia" +
            ",AVG((CAST(P9 AS DECIMAL) + CAST(P10 AS DECIMAL) + CAST(P11 AS DECIMAL) + CAST(P12 AS DECIMAL))/4) AS PromContenidos" +
            ",AVG((CAST(P13 AS DECIMAL) + CAST(P14 AS DECIMAL) + CAST(P15 AS DECIMAL) + CAST(P16 AS DECIMAL))/4) AS PromClima" +
            ",AVG((CAST(P17 AS DECIMAL) + CAST(P18 AS DECIMAL) + CAST(P19 AS DECIMAL))/3) AS PromEvaluacion" +
            ",AVG((CAST(P20 AS DECIMAL) + CAST(P21 AS DECIMAL) + CAST(P22 AS DECIMAL))/3) AS PromDeberes" +
            ",AVG((CAST(P23 AS DECIMAL) + CAST(P24 AS DECIMAL) + CAST(P25 AS DECIMAL) + CAST(P26 AS DECIMAL))/4) AS PromMoodle " +
            "FROM dbo.SEK_EAdocentePE WHERE  CODPROF='" + profesor + "' " +
            "AND ANO='" + ano + "' AND PERIODO='" + periodo + "' AND CODRAMO='" + asignatura + "' AND SECCION='" + seccion + "'"
        ...
        Try
            ...
            lblDeberes1.Text = Mid(ds.Tables(0).Rows(0)("P20").ToString(), 1, decimales)
            lblDeberes2.Text = Mid(ds.Tables(0).Rows(0)("P21").ToString(), 1, decimales)
            lblDeberes3.Text = Mid(ds.Tables(0).Rows(0)("P22").ToString(), 1, decimales)

            lblMoodle1.Text = Mid(ds.Tables(0).Rows(0)("P23").ToString(), 1, decimales)
            lblMoodle2.Text = Mid(ds.Tables(0).Rows(0)("P24").ToString(), 1, decimales)
            lblMoodle3.Text = Mid(ds.Tables(0).Rows(0)("P25").ToString(), 1, decimales)
            lblMoodle4.Text = Mid(ds.Tables(0).Rows(0)("P26").ToString(), 1, decimales)
            ...
            lblPromMoodle.Text = Mid(ds.Tables(0).Rows(0)("PromMoodle").ToString(), 1, decimales)
        ...
        strSql = "SELECT" +
          " AVG(CAST(P1 AS DECIMAL)) AS P1" +
            ...
            ",AVG((CAST(P20 AS DECIMAL) + CAST(P21 AS DECIMAL) + CAST(P22 AS DECIMAL))/3) AS PromDeberes" +
            ",AVG((CAST(P23 AS DECIMAL) + CAST(P24 AS DECIMAL) + CAST(P25 AS DECIMAL) + CAST(P26 AS DECIMAL))/4) AS PromMoodle" +
            " FROM dbo.SEK_EAdocentePE WHERE  CARRERA like '%" + nomCarrera + "%' AND ANO='" + ano + "' AND PERIODO='" + periodo + "'"
        Try
            conn.Open()
            da = New SqlDataAdapter(strSql, conn)
            da.Fill(ds2)
            ...
            lblDeberes1Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P20").ToString(), 1, decimales)
            lblDeberes2Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P21").ToString(), 1, decimales)
            lblDeberes3Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P22").ToString(), 1, decimales)

            lblMoodle1Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P23").ToString(), 1, decimales)
            lblMoodle2Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P24").ToString(), 1, decimales)
            lblMoodle3Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P25").ToString(), 1, decimales)
            lblMoodle4Carrera.Text = Mid(ds2.Tables(0).Rows(0)("P26").ToString(), 1, decimales)
            ...
            lblPromMoodleCarrera.Text = Mid(ds2.Tables(0).Rows(0)("PromMoodle").ToString(), 1, decimales)
