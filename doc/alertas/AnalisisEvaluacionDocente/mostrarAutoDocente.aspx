<%@ Page Title="Auto Evaluación Docente" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="mostrarAutoDocente.aspx.vb" Inherits="mostrarEvEstudianteDocente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table class="tablaInforme">
        <tbody>
            ...
            <tr>
                <td><span>1. Cada vez que inicio una clase, formulo preguntas para indagar el nivel de conocimiento o experiencias que puedan tener los estudiantes al respecto.</span></td>
                <td><asp:Label ID="lblContenido1" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblContenido1Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>2. El nivel de dificultad y profundidad de los contenidos y materias revisadas en el curso se relacionan con los objetivos del programa.</span></td>
                <td><asp:Label ID="lblContenido2" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblContenido2Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>3. A lo largo del curso, desarrollo progresivamente los contenidos de la asignatura, desde lo más simple a los más copmlejo.</span></td>
                <td><asp:Label ID="lblContenido3" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblContenido3Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>4. Considero que a travéz de mi proceso de enseñanza los estudiantes podrían resolver problemas en diversos contextos.</span></td>
            ...
            <tr>
                ...
                <th><asp:Label ID="lblClimaProm" runat="server"></asp:Label></th>
                <th><asp:Label ID="lblClimaPromCarrera" runat="server"></asp:Label></th>
            </tr>
            <tr>
                <td><span>1. Me preocupo de responder las dudas e inquietudes que me plantean los estudiantes en clases.</span></td>
                <td><asp:Label ID="lblClima1" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblClima1Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>2. En clases mantengo una comunicación clara, sensible y empática con mis estudiantes.</span></td>
                <td><asp:Label ID="lblClima2" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblClima2Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>3. Como profesor, confío en las capacidades de mis estudiantes para afrontar adecuadamente los contenidos y evaluaciones de la asignatura.</span></td>
            ...
            <tr>
                <td><span>1. El nivel de dificultad de las pruebas y exámenes aplicados es coherente con el tratamiento que realizo de las materias en clases.</span></td>
            ...
            <tr>
                <td><span>3. En las correcciones de las evaluaciones, muestro a los estudiantes claramente sus errores y la forma en que pueden superarlos.</span></td>
                <td><asp:Label ID="lblEval3" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblEval3Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>4. Realizo una entrega oportuna(según reglamento) de las correcciones y notas de cada evaluación que tomo en el transcurso de la asignatura.</span></td>
            ...
            <tr>
                <td><span>4. Registro en el libro de clases los contenidos que imparto en cada sesión.</span></td>
                <td><asp:Label ID="lblDeberes4" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblDeberes4Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>5. Actualizo oportunamente la información de mi portal docente.</span></td>
                <td><asp:Label ID="lblDeberes5" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblDeberes5Carrera" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><span>6. Asisto regularmente a los claustros que se organizan en la carrera.</span></td>
                <td><asp:Label ID="lblDeberes6" runat="server"></asp:Label></td>
                <td><asp:Label ID="lblDeberes6Carrera" runat="server"></asp:Label></td>
            </tr>
        </tbody>
    </table>
