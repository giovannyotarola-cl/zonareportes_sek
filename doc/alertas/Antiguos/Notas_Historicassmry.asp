...
<% If sClearExtFilter = "Notas_Historicas_RUT" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Notas_Historicas_AD1OINGRESO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">AÑOINGRESO</span></td>
...
<% If sClearExtFilter = "Notas_Historicas_AD1O_MAT" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">AÑO MAT</span></td>
		<td><span class="ewrptSearchOpr">:
...
<% If sClearExtFilter = "Notas_Historicas_PER_MAT" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">PER MAT</span></td>
		<td><span class="ewrptSearchOpr">:
...
<% If sClearExtFilter = "Notas_Historicas_PER_RAMO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">PER RAMO</span></td>
		<td><span class="ewrptSearchOpr">:
...
<table class="ewRptExtFilter">
	<tr>
		<td><span class="aspreportmaker">
			...
			<input type="Reset" name="Reset" id="Reset" value="Canclar">&nbsp;
		</span></td>
	</tr>
</table>
</form>
...
Function GetExtendedFilter()
	...
	ElseIf Request.QueryString("cmd") = "reset" Then
		...
		' Field RUT
		Call SetSessionFilterValues(sv1_RUT, so1_RUT, sc_RUT, sv2_RUT, so2_RUT, "Notas_Historicas_RUT")
	...
	If bRestoreSession Then
		...
		' Field RUT
		Call GetSessionFilterValues(sv1_RUT, so1_RUT, sc_RUT, sv2_RUT, so2_RUT, "Notas_Historicas_RUT")
