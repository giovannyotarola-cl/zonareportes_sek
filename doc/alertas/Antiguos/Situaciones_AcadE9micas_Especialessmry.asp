...
' ASP Report Maker 3.0+ - Table level configuration (Situaciones Académicas Especiales)
' Table Level Constants

Const EW_REPORT_TABLE_VAR = "Situaciones_AcadE9micas_Especiales"
Const EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE = "Situaciones_AcadE9micas_Especiales_grpperpage"
Const EW_REPORT_TABLE_SESSION_START_GROUP = "Situaciones_AcadE9micas_Especiales_start"
Const EW_REPORT_TABLE_SESSION_SEARCH = "Situaciones_AcadE9micas_Especiales_search"
Const EW_REPORT_TABLE_SESSION_CHILD_USER_ID = "Situaciones_AcadE9micas_Especiales_childuserid"
Const EW_REPORT_TABLE_SESSION_ORDER_BY = "Situaciones_AcadE9micas_Especiales_orderby"

' Table Level SQL
Const EW_REPORT_TABLE_SQL_FROM = "[Vista_SituacionesAcademicas]"
...
Dim af_TIPOSITU ' Advanced filter for TIPOSITU
...
Dim x_TIPOSITU: x_TIPOSITU = Null
...
Dim o_TIPOSITU, t_TIPOSITU, ft_TIPOSITU
o_TIPOSITU = Null: t_TIPOSITU = Null: ft_TIPOSITU = 131
Dim rf_TIPOSITU, rt_TIPOSITU
...
<% End If %>
<div id="underline">
	<h1>Situaciones Académicas Especiales</h1>
</div>
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Situaciones_AcadE9micas_Especialessmry.asp?export=excel"><img src="../../images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If sExport = "" Then %>
</div></td></tr>
...
&nbsp;&nbsp;<a href="Situaciones_AcadE9micas_Especialessmry.asp?cmd=reset">Resetear Filtros</a>
<% End If %>
<br><br>
<div id="ewrptExtFilterPanel"<%= sDivDisplay %>>
<!-- Search form (begin) -->
<form name="fSituaciones_AcadE9micas_Especialessummaryfilter" id="fSituaciones_AcadE9micas_Especialessummaryfilter" action="Situaciones_AcadE9micas_Especialessmry.asp" class="ewForm" onSubmit="return ewrpt_ValidateExtFilter(this);">
...
%>
	<tr>
		...
		<select name="sv_FACULTAD" id="sv_FACULTAD"<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_FACULTAD" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
%>
	...
	<tr>
		...
		<td><span class="ewrptSearchOpr">:</span></td>
		<td colspan="4"><span class="ewRptSearchOpr">
		<select name="sv_CARRERA" id="sv_CARRERA"<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_CARRERA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_ANO_MAT" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_PERIODO_MAT" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<input type="text" name="sv1_PERIODO_MAT" id="sv1_PERIODO_MAT" size="30" value="<%= Server.HTMLEncode(sv1_PERIODO_MAT&"") %>"<%= sClearInputClass %>>
	...
	<tr>
		<td><span class="aspreportmaker">DESCRIPCION</span></td>
		<td><span class="ewrptSearchOpr">:</span></td>
		<td colspan="4"><span class="ewRptSearchOpr">
		<select name="sv_DESCRIPCION" id="sv_DESCRIPCION"<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_DESCRIPCION" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_ANO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Situaciones_AcadE9micas_Especiales_PERIODO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<form action="Situaciones_AcadE9micas_Especialessmry.asp" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Situaciones_AcadE9micas_Especialessmry.asp?start=<%= Pager.FirstButton.Start %>"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<% Else %>
	<td><img src="rptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<% End If %>
<!--previous page button-->
	<% If Pager.PrevButton.Enabled Then %>
	<td><a href="Situaciones_AcadE9micas_Especialessmry.asp?start=<%= Pager.PrevButton.Start %>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<% Else %>
...
<!--next page button-->
	...
	<td><a href="Situaciones_AcadE9micas_Especialessmry.asp?start=<%= Pager.NextButton.Start %>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<% Else %>
	<td><img src="rptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<% End If %>
<!--last page button-->
	<% If Pager.LastButton.Enabled Then %>
	<td><a href="Situaciones_AcadE9micas_Especialessmry.asp?start=<%= Pager.LastButton.Start %>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<% Else %>
...
Sub GetRow(opt)
	...
	If Not rs.Eof Then
		...
		x_TIPOSITU = ewrpt_GetValue(rs("TIPOSITU"))
		If Not IsNull(x_TIPOSITU) Then x_TIPOSITU = CDbl(x_TIPOSITU)
...
Function GetExtendedFilter()
	...
	ElseIf Request.QueryString("cmd") = "reset" Then
		...
		Call SetSessionDropDownValue(sv_FACULTAD, "Situaciones_AcadE9micas_Especiales_FACULTAD")

		' Field CARRERA
		Call SetSessionDropDownValue(sv_CARRERA, "Situaciones_AcadE9micas_Especiales_CARRERA")

		' Field ANO_MAT
		Call SetSessionFilterValues(sv1_ANO_MAT, so1_ANO_MAT, sc_ANO_MAT, sv2_ANO_MAT, so2_ANO_MAT, "Situaciones_AcadE9micas_Especiales_ANO_MAT")

		' Field PERIODO_MAT
		Call SetSessionFilterValues(sv1_PERIODO_MAT, so1_PERIODO_MAT, sc_PERIODO_MAT, sv2_PERIODO_MAT, so2_PERIODO_MAT, "Situaciones_AcadE9micas_Especiales_PERIODO_MAT")

		' Field DESCRIPCION
		Call SetSessionDropDownValue(sv_DESCRIPCION, "Situaciones_AcadE9micas_Especiales_DESCRIPCION")

		' Field ANO
		Call SetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Situaciones_AcadE9micas_Especiales_ANO")

		' Field PERIODO
		Call SetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Situaciones_AcadE9micas_Especiales_PERIODO")
	...
	Else
		...
		ElseIf Not IsArray(sv_FACULTAD) Then
			If sv_FACULTAD <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Situaciones_AcadE9micas_Especiales_FACULTAD")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
		...
		ElseIf Not IsArray(sv_CARRERA) Then
			If sv_CARRERA <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Situaciones_AcadE9micas_Especiales_CARRERA")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
		...
		ElseIf Not IsArray(sv_DESCRIPCION) Then
			If sv_DESCRIPCION <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Situaciones_AcadE9micas_Especiales_DESCRIPCION")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
	...
	If bRestoreSession Then
		...
		' Field FACULTAD
		Call GetSessionDropDownValue(sv_FACULTAD, "Situaciones_AcadE9micas_Especiales_FACULTAD")

		' Field CARRERA
		Call GetSessionDropDownValue(sv_CARRERA, "Situaciones_AcadE9micas_Especiales_CARRERA")

		' Field ANO_MAT
		Call GetSessionFilterValues(sv1_ANO_MAT, so1_ANO_MAT, sc_ANO_MAT, sv2_ANO_MAT, so2_ANO_MAT, "Situaciones_AcadE9micas_Especiales_ANO_MAT")

		' Field PERIODO_MAT
		Call GetSessionFilterValues(sv1_PERIODO_MAT, so1_PERIODO_MAT, sc_PERIODO_MAT, sv2_PERIODO_MAT, so2_PERIODO_MAT, "Situaciones_AcadE9micas_Especiales_PERIODO_MAT")

		' Field DESCRIPCION
		Call GetSessionDropDownValue(sv_DESCRIPCION, "Situaciones_AcadE9micas_Especiales_DESCRIPCION")

		' Field ANO
		Call GetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Situaciones_AcadE9micas_Especiales_ANO")

		' Field PERIODO
		Call GetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Situaciones_AcadE9micas_Especiales_PERIODO")
	End If
...
Function getSort()
	...
	If Request.QueryString("cmd").Count > 0 Then
		...
		If sCmd = "resetsort" Then
			...
			Session("sort_Situaciones_AcadE9micas_Especiales_FACULTAD") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_CARRERA") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_RUT") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_PATERNO") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_MATERNO") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_NOMBRE") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_CODCLI") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_ANO_MAT") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_PERIODO_MAT") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_TIPOSITU") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_DESCRIPCION") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_ANO") = ""
			Session("sort_Situaciones_AcadE9micas_Especiales_PERIODO") = ""
		End If
