...
' ASP Report Maker 3.0+ - Table level configuration (Ramossinpond)
' Table Level Constants

Const EW_REPORT_TABLE_VAR = "Ramossinpond"
Const EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE = "Ramossinpond_grpperpage"
Const EW_REPORT_TABLE_SESSION_START_GROUP = "Ramossinpond_start"
Const EW_REPORT_TABLE_SESSION_SEARCH = "Ramossinpond_search"
Const EW_REPORT_TABLE_SESSION_CHILD_USER_ID = "Ramossinpond_childuserid"
Const EW_REPORT_TABLE_SESSION_ORDER_BY = "Ramossinpond_orderby"

' Table Level SQL
Const EW_REPORT_TABLE_SQL_FROM = "[Vista_Ramossinpond]"
...
Dim nDisplayGrps: nDisplayGrps = 3 ' Groups per page
...
Ramossinpond
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Ramossinpondsmry.asp?export=excel">Export to Excel</a>
<% If bFilterApplied Then %>
&nbsp;&nbsp;<a href="Ramossinpondsmry.asp?cmd=reset">Reset All Filters</a>
<% End If %>
<% End If %>
<br><br>
<% If sExport = "" Then %>
...
End If
%>
<a href="javascript:ewrpt_ToggleFilterPanel();" style="text-decoration: none;"><img id="ewrptToggleFilterImg" src="<%= sButtonImage %>" alt="" width="9" height="9" border="0"></a><span class="aspreportmaker">&nbsp;Filters</span><br><br>
<div id="ewrptExtFilterPanel"<%= sDivDisplay %>>
<!-- Search form (begin) -->
<form name="fRamossinpondsummaryfilter" id="fRamossinpondsummaryfilter" action="Ramossinpondsmry.asp" class="ewForm" onSubmit="return ewrpt_ValidateExtFilter(this);">
...
%>
	<tr>
		...
		<select name="sv_FACULTAD" id="sv_FACULTAD"<% If sClearExtFilter = "Ramossinpond_FACULTAD" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
%>
	...
	<tr>
		...
		<td></td>
		<td colspan="4"><span class="ewRptSearchOpr">
		<select name="sv_CARRERA" id="sv_CARRERA"<% If sClearExtFilter = "Ramossinpond_CARRERA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
<% If sClearExtFilter = "Ramossinpond_CODRAMO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">CODRAMO</span></td>
		<td><span class="ewrptSearchOpr">=<input type="hidden" name="so1_CODRAMO" id="so1_CODRAMO" value="="></span></td>
		<td>
...
<% If sClearExtFilter = "Ramossinpond_CODSECC" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">CODSECC</span></td>
		<td><span class="ewrptSearchOpr">=<input type="hidden" name="so1_CODSECC" id="so1_CODSECC" value="="></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If sClearExtFilter = "Ramossinpond_CODPROF" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">CODPROF</span></td>
		<td><span class="ewrptSearchOpr">=<input type="hidden" name="so1_CODPROF" id="so1_CODPROF" value="="></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If sClearExtFilter = "Ramossinpond_ANO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">ANO</span></td>
...
<% If sClearExtFilter = "Ramossinpond_PERIODO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<form action="Ramossinpondsmry.asp" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Ramossinpondsmry.asp?start=<%= Pager.FirstButton.Start %>"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<% Else %>
	<td><img src="rptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<% End If %>
<!--previous page button-->
	<% If Pager.PrevButton.Enabled Then %>
	<td><a href="Ramossinpondsmry.asp?start=<%= Pager.PrevButton.Start %>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<% Else %>
...
<!--next page button-->
	...
	<td><a href="Ramossinpondsmry.asp?start=<%= Pager.NextButton.Start %>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<% Else %>
	<td><img src="rptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<% End If %>
<!--last page button-->
	<% If Pager.LastButton.Enabled Then %>
	<td><a href="Ramossinpondsmry.asp?start=<%= Pager.LastButton.Start %>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<% Else %>
...
Function GetExtendedFilter()
	...
	ElseIf Request.QueryString("cmd") = "reset" Then
		...
		Call SetSessionDropDownValue(sv_FACULTAD, "Ramossinpond_FACULTAD")

		' Field CARRERA
		Call SetSessionDropDownValue(sv_CARRERA, "Ramossinpond_CARRERA")

		' Field CODRAMO
		Call SetSessionFilterValues(sv1_CODRAMO, so1_CODRAMO, sc_CODRAMO, sv2_CODRAMO, so2_CODRAMO, "Ramossinpond_CODRAMO")

		' Field CODSECC
		Call SetSessionFilterValues(sv1_CODSECC, so1_CODSECC, sc_CODSECC, sv2_CODSECC, so2_CODSECC, "Ramossinpond_CODSECC")

		' Field CODPROF
		Call SetSessionFilterValues(sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF, "Ramossinpond_CODPROF")

		' Field ANO
		Call SetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Ramossinpond_ANO")

		' Field PERIODO
		Call SetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Ramossinpond_PERIODO")
	...
	Else
		...
		ElseIf Not IsArray(sv_FACULTAD) Then
			If sv_FACULTAD <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Ramossinpond_FACULTAD")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
		...
		ElseIf Not IsArray(sv_CARRERA) Then
			If sv_CARRERA <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Ramossinpond_CARRERA")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
	...
	If bRestoreSession Then
		...
		' Field FACULTAD
		Call GetSessionDropDownValue(sv_FACULTAD, "Ramossinpond_FACULTAD")

		' Field CARRERA
		Call GetSessionDropDownValue(sv_CARRERA, "Ramossinpond_CARRERA")

		' Field CODRAMO
		Call GetSessionFilterValues(sv1_CODRAMO, so1_CODRAMO, sc_CODRAMO, sv2_CODRAMO, so2_CODRAMO, "Ramossinpond_CODRAMO")

		' Field CODSECC
		Call GetSessionFilterValues(sv1_CODSECC, so1_CODSECC, sc_CODSECC, sv2_CODSECC, so2_CODSECC, "Ramossinpond_CODSECC")

		' Field CODPROF
		Call GetSessionFilterValues(sv1_CODPROF, so1_CODPROF, sc_CODPROF, sv2_CODPROF, so2_CODPROF, "Ramossinpond_CODPROF")

		' Field ANO
		Call GetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Ramossinpond_ANO")

		' Field PERIODO
		Call GetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Ramossinpond_PERIODO")
	End If
...
Function getSort()
	...
	If Request.QueryString("cmd").Count > 0 Then
		...
		If sCmd = "resetsort" Then
			...
			Session("sort_Ramossinpond_FACULTAD") = ""
			Session("sort_Ramossinpond_CARRERA") = ""
			Session("sort_Ramossinpond_RAMO") = ""
			Session("sort_Ramossinpond_JORNADA") = ""
			Session("sort_Ramossinpond_CODRAMO") = ""
			Session("sort_Ramossinpond_CODSECC") = ""
			Session("sort_Ramossinpond_CODPROF") = ""
			Session("sort_Ramossinpond_RUT") = ""
			Session("sort_Ramossinpond_DV") = ""
			Session("sort_Ramossinpond_AP_PATER") = ""
			Session("sort_Ramossinpond_AP_MATER") = ""
			Session("sort_Ramossinpond_NOMBRES") = ""
			Session("sort_Ramossinpond_ANO") = ""
			Session("sort_Ramossinpond_PERIODO") = ""
			Session("sort_Ramossinpond_PORCERT1") = ""
			Session("sort_Ramossinpond_np") = ""
		End If
