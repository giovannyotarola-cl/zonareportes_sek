...
' ASP Report Maker 3.0+ - Table level configuration (Toma de Ramos)
...
Dim af_nombrealu ' Advanced filter for nombrealu
%>
...
Dim x_nombrealu: x_nombrealu = Null
...
Dim o_nombrealu, t_nombrealu, ft_nombrealu
o_nombrealu = Null: t_nombrealu = Null: ft_nombrealu = 200
Dim rf_nombrealu, rt_nombrealu
%>
<%
...
Dim col(11), val(11), cnt(0,11)
Dim smry(0,11), mn(0,11), mx(0,11)
Dim grandsmry(11), grandmn(11), grandmx(11)
...
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Toma_de_Ramossmry.asp?export=excel"><img src="../../images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If sExport = "" Then %>
</div></td></tr>
...
&nbsp;&nbsp;<a href="Toma_de_Ramossmry.asp?cmd=reset">Resetear Filtros</a>
<% End If %>
<br><br>
<div id="ewrptExtFilterPanel"<%= sDivDisplay %>>
<!-- Search form (begin) -->
<form name="fToma_de_Ramossummaryfilter" id="fToma_de_Ramossummaryfilter" action="Toma_de_Ramossmry.asp" class="ewForm" onSubmit="return ewrpt_ValidateExtFilter(this);">
...
<% If sClearExtFilter = "Toma_de_Ramos_RUT" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		...
		<td><span class="ewrptSearchOpr">:
		    <input type="hidden" name="so1_RUT" id="so1_RUT" value="LIKE"></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
%>
<% If nTotalGrps > 0 Then %>
	<!-- tr><td colspan="11"><span class="aspreportmaker">&nbsp;<br></span></td></tr -->
	<tr class="ewRptGrandSummary">
	  <td colspan="11">Total General(<%= FormatNumber(rstotcnt,0) %>Registros)</td></tr>
<% End If %>
	</tfoot>
</table>
</div>
...
<form action="Toma_de_Ramossmry.asp" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Toma_de_Ramossmry.asp?start=<%= Pager.FirstButton.Start %>"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<% Else %>
	<td><img src="rptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<% End If %>
<!--previous page button-->
	<% If Pager.PrevButton.Enabled Then %>
	<td><a href="Toma_de_Ramossmry.asp?start=<%= Pager.PrevButton.Start %>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<% Else %>
...
<!--next page button-->
	...
	<td><a href="Toma_de_Ramossmry.asp?start=<%= Pager.NextButton.Start %>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<% Else %>
	<td><img src="rptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<% End If %>
<!--last page button-->
	<% If Pager.LastButton.Enabled Then %>
	<td><a href="Toma_de_Ramossmry.asp?start=<%= Pager.LastButton.Start %>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<% Else %>
...
Sub GetRow(opt)
	...
	If Not rs.Eof Then
		...
		x_nombrealu = ewrpt_GetValue(rs("nombrealu"))
		val(1) = x_FACULTAD
		val(2) = x_CARRERA
		val(3) = x_NOMBRE
		val(4) = x_CODSECC
...
Function getSort()
	...
	If Request.QueryString("cmd").Count > 0 Then
		...
		If sCmd = "resetsort" Then
			...
			Session("sort_Toma_de_Ramos_nombrealu") = ""
		End If
