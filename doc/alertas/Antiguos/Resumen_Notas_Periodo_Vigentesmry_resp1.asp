...
<% If sClearExtFilter = "Resumen_Notas_Periodo_Vigente_JORNADA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		...
		<td><span class="ewrptSearchOpr">:
		    <input type="hidden" name="so1_JORNADA" id="so1_JORNADA" value="LIKE"></span></td>
		<td>
...
<% If nTotalGrps > 0 Then %>
	...
	<tr class="ewRptGrandSummary"><td colspan="27">Grand Total (<%= FormatNumber(rstotcnt,0) %> Detail Records)</td></tr>
<% End If %>
	</tfoot>
</table>
</div>
