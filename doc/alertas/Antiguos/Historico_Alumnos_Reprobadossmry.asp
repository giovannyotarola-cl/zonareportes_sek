...
' ASP Report Maker 3.0+ - Table level configuration (Historico Alumnos Reprobados)
' Table Level Constants

Const EW_REPORT_TABLE_VAR = "Historico_Alumnos_Reprobados"
Const EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE = "Historico_Alumnos_Reprobados_grpperpage"
Const EW_REPORT_TABLE_SESSION_START_GROUP = "Historico_Alumnos_Reprobados_start"
Const EW_REPORT_TABLE_SESSION_SEARCH = "Historico_Alumnos_Reprobados_search"
Const EW_REPORT_TABLE_SESSION_CHILD_USER_ID = "Historico_Alumnos_Reprobados_childuserid"
Const EW_REPORT_TABLE_SESSION_ORDER_BY = "Historico_Alumnos_Reprobados_orderby"
...
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Historico_Alumnos_Reprobadossmry.asp?export=excel"><img src="../../images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If sExport = "" Then %>
</div></td></tr>
...
&nbsp;&nbsp;<a href="Historico_Alumnos_Reprobadossmry.asp?cmd=reset">Resetear Filtros</a>
<% End If %>
<br><br>
<div id="ewrptExtFilterPanel"<%= sDivDisplay %>>
<!-- Search form (begin) -->
<form name="fHistorico_Alumnos_Reprobadossummaryfilter" id="fHistorico_Alumnos_Reprobadossummaryfilter" action="Historico_Alumnos_Reprobadossmry.asp" class="ewForm" onSubmit="return ewrpt_ValidateExtFilter(this);">
...
%>
	<tr>
		...
		<select name="sv_FACULTAD" id="sv_FACULTAD"<% If sClearExtFilter = "Historico_Alumnos_Reprobados_FACULTAD" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
%>
	...
	<tr>
		...
		<td><span class="ewrptSearchOpr">:</span></td>
		<td colspan="4"><span class="ewRptSearchOpr">
		<select name="sv_CARRERA" id="sv_CARRERA"<% If sClearExtFilter = "Historico_Alumnos_Reprobados_CARRERA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>>
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_CODRAMO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_CODSECC" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_ANO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">A&Ntilde;O</span></td>
		<td><span class="ewrptSearchOpr">:
		    <input type="hidden" name="so1_ANO" id="so1_ANO" value="LIKE"></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_PERIODO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">PERIODO</span></td>
		<td><span class="ewrptSearchOpr">:
		    <input type="hidden" name="so1_PERIODO" id="so1_PERIODO" value="LIKE"></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_NP" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_NF" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If sClearExtFilter = "Historico_Alumnos_Reprobados_ASISTENCIA" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
...
<% If nTotalGrps > 0 Then %>
	...
	<tr class="ewRptGrandSummary">
	  <td colspan="33">Total General (<%= FormatNumber(rstotcnt,0) %> Registros)</td></tr>
<% End If %>
	</tfoot>
</table>
</div>
...
<form action="Historico_Alumnos_Reprobadossmry.asp" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Historico_Alumnos_Reprobadossmry.asp?start=<%= Pager.FirstButton.Start %>"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<% Else %>
	<td><img src="rptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<% End If %>
<!--previous page button-->
	<% If Pager.PrevButton.Enabled Then %>
	<td><a href="Historico_Alumnos_Reprobadossmry.asp?start=<%= Pager.PrevButton.Start %>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<% Else %>
...
<!--next page button-->
	...
	<td><a href="Historico_Alumnos_Reprobadossmry.asp?start=<%= Pager.NextButton.Start %>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<% Else %>
	<td><img src="rptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<% End If %>
<!--last page button-->
	<% If Pager.LastButton.Enabled Then %>
	<td><a href="Historico_Alumnos_Reprobadossmry.asp?start=<%= Pager.LastButton.Start %>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<% Else %>
...
Function GetExtendedFilter()
	...
	ElseIf Request.QueryString("cmd") = "reset" Then
		...
		Call SetSessionDropDownValue(sv_FACULTAD, "Historico_Alumnos_Reprobados_FACULTAD")

		' Field CARRERA
		Call SetSessionDropDownValue(sv_CARRERA, "Historico_Alumnos_Reprobados_CARRERA")

		' Field CODRAMO
		Call SetSessionFilterValues(sv1_CODRAMO, so1_CODRAMO, sc_CODRAMO, sv2_CODRAMO, so2_CODRAMO, "Historico_Alumnos_Reprobados_CODRAMO")

		' Field CODSECC
		Call SetSessionFilterValues(sv1_CODSECC, so1_CODSECC, sc_CODSECC, sv2_CODSECC, so2_CODSECC, "Historico_Alumnos_Reprobados_CODSECC")

		' Field ANO
		Call SetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Historico_Alumnos_Reprobados_ANO")

		' Field PERIODO
		Call SetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Historico_Alumnos_Reprobados_PERIODO")

		' Field NP
		Call SetSessionFilterValues(sv1_NP, so1_NP, sc_NP, sv2_NP, so2_NP, "Historico_Alumnos_Reprobados_NP")

		' Field NF
		Call SetSessionFilterValues(sv1_NF, so1_NF, sc_NF, sv2_NF, so2_NF, "Historico_Alumnos_Reprobados_NF")

		' Field ASISTENCIA
		Call SetSessionFilterValues(sv1_ASISTENCIA, so1_ASISTENCIA, sc_ASISTENCIA, sv2_ASISTENCIA, so2_ASISTENCIA, "Historico_Alumnos_Reprobados_ASISTENCIA")
	...
	Else
		...
		ElseIf Not IsArray(sv_FACULTAD) Then
			If sv_FACULTAD <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Historico_Alumnos_Reprobados_FACULTAD")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
		...
		ElseIf Not IsArray(sv_CARRERA) Then
			If sv_CARRERA <> EW_REPORT_INIT_VALUE And IsEmpty(Session("sv_Historico_Alumnos_Reprobados_CARRERA")) Then
				bSetupFilter = True ' Set up filter required
			End If
		End If
	...
	If bRestoreSession Then
		...
		' Field FACULTAD
		Call GetSessionDropDownValue(sv_FACULTAD, "Historico_Alumnos_Reprobados_FACULTAD")

		' Field CARRERA
		Call GetSessionDropDownValue(sv_CARRERA, "Historico_Alumnos_Reprobados_CARRERA")

		' Field CODRAMO
		Call GetSessionFilterValues(sv1_CODRAMO, so1_CODRAMO, sc_CODRAMO, sv2_CODRAMO, so2_CODRAMO, "Historico_Alumnos_Reprobados_CODRAMO")

		' Field CODSECC
		Call GetSessionFilterValues(sv1_CODSECC, so1_CODSECC, sc_CODSECC, sv2_CODSECC, so2_CODSECC, "Historico_Alumnos_Reprobados_CODSECC")

		' Field ANO
		Call GetSessionFilterValues(sv1_ANO, so1_ANO, sc_ANO, sv2_ANO, so2_ANO, "Historico_Alumnos_Reprobados_ANO")

		' Field PERIODO
		Call GetSessionFilterValues(sv1_PERIODO, so1_PERIODO, sc_PERIODO, sv2_PERIODO, so2_PERIODO, "Historico_Alumnos_Reprobados_PERIODO")

		' Field NP
		Call GetSessionFilterValues(sv1_NP, so1_NP, sc_NP, sv2_NP, so2_NP, "Historico_Alumnos_Reprobados_NP")

		' Field NF
		Call GetSessionFilterValues(sv1_NF, so1_NF, sc_NF, sv2_NF, so2_NF, "Historico_Alumnos_Reprobados_NF")

		' Field ASISTENCIA
		Call GetSessionFilterValues(sv1_ASISTENCIA, so1_ASISTENCIA, sc_ASISTENCIA, sv2_ASISTENCIA, so2_ASISTENCIA, "Historico_Alumnos_Reprobados_ASISTENCIA")
	End If
...
Sub LoadDefaultFilters()
	...
	so1d_ANO = "LIKE" ' Default search operator 1
	...
	so1d_PERIODO = "LIKE" ' Default search operator 1
...
Function getSort()
	...
	If Request.QueryString("cmd").Count > 0 Then
		...
		If sCmd = "resetsort" Then
			...
			Session("sort_Historico_Alumnos_Reprobados_FACULTAD") = ""
			Session("sort_Historico_Alumnos_Reprobados_CARRERA") = ""
			Session("sort_Historico_Alumnos_Reprobados_RAMO") = ""
			Session("sort_Historico_Alumnos_Reprobados_RUT") = ""
			Session("sort_Historico_Alumnos_Reprobados_DIG") = ""
			Session("sort_Historico_Alumnos_Reprobados_PATERNO") = ""
			Session("sort_Historico_Alumnos_Reprobados_MATERNO") = ""
			Session("sort_Historico_Alumnos_Reprobados_NOMBRE") = ""
			Session("sort_Historico_Alumnos_Reprobados_CODRAMO") = ""
			Session("sort_Historico_Alumnos_Reprobados_CODSECC") = ""
			Session("sort_Historico_Alumnos_Reprobados_CODCLI") = ""
			Session("sort_Historico_Alumnos_Reprobados_ANO") = ""
			Session("sort_Historico_Alumnos_Reprobados_PERIODO") = ""
			Session("sort_Historico_Alumnos_Reprobados_NP") = ""
			Session("sort_Historico_Alumnos_Reprobados_NE") = ""
			Session("sort_Historico_Alumnos_Reprobados_NPR") = ""
			Session("sort_Historico_Alumnos_Reprobados_NER") = ""
			Session("sort_Historico_Alumnos_Reprobados_NEP") = ""
			Session("sort_Historico_Alumnos_Reprobados_NERP") = ""
			Session("sort_Historico_Alumnos_Reprobados_NF") = ""
			Session("sort_Historico_Alumnos_Reprobados_NFP") = ""
			Session("sort_Historico_Alumnos_Reprobados_ESTADO") = ""
			Session("sort_Historico_Alumnos_Reprobados_ASISTENCIA") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT1") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT2") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT3") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT4") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT5") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT6") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT7") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT8") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT9") = ""
			Session("sort_Historico_Alumnos_Reprobados_NCERT10") = ""
		End If
