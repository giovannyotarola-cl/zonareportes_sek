...
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Ramos_Sin_Ponderarsmry.asp?export=excel"><img src="../../images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If sExport = "" Then %>
</div></td></tr>
...
&nbsp;&nbsp;<a href="Ramos_Sin_Ponderarsmry.asp?cmd=reset">Resetear Filtros</a>
<% End If %>
<br><br>
...
<% If nTotalGrps > 0 Then %>
	...
	<tr class="ewRptGrandSummary">
	  <td colspan="15">Total General(<%= FormatNumber(rstotcnt,0) %> Registros)</td></tr>
<% End If %>
	</tfoot>
</table>
</div>
...
<td><span class="aspreportmaker">P&aacute;ina&nbsp;</span></td>
<!--first page button-->
