...
Dim col(26), val(26), cnt(0,26)
Dim smry(0,26), mn(0,26), mx(0,26)
Dim grandsmry(26), grandmn(26), grandmx(26)
...
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Asignaturas_Historicassmry.asp?export=excel"><img src="../../images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If sExport = "" Then %>
</div></td></tr>
...
&nbsp;&nbsp;<a href="Asignaturas_Historicassmry.asp?cmd=reset">Resetear Filtros</a>
<% End If %>
<br><br>
<div id="ewrptExtFilterPanel"<%= sDivDisplay %>>
<!-- Search form (begin) -->
<form name="fAsignaturas_Historicassummaryfilter" id="fAsignaturas_Historicassummaryfilter" action="Asignaturas_Historicassmry.asp" class="ewForm" onSubmit="return ewrpt_ValidateExtFilter(this);">
...
<% If sClearExtFilter = "Asignaturas_Historicas_CODRAMO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		<td><span class="aspreportmaker">C&Oacute;DIGO ASIGNATURA</span></td>
		<td><span class="ewrptSearchOpr">:<input type="hidden" name="so1_CODRAMO" id="so1_CODRAMO" value="LIKE"></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If sClearExtFilter = "Asignaturas_Historicas_ANO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		...
		<td><span class="ewrptSearchOpr">:<input type="hidden" name="so1_ANO" id="so1_ANO" value="="></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If sClearExtFilter = "Asignaturas_Historicas_PERIODO" Then sClearInputClass = " class=""ewInputCleared""" Else sClearInputClass = "" %>
	<tr>
		...
		<td><span class="ewrptSearchOpr">:<input type="hidden" name="so1_PERIODO" id="so1_PERIODO" value="="></span></td>
		<td>
			<table cellspacing="0" class="ewItemTable"><tr>
				<td><span class="aspreportmaker">
...
<% If nTotalGrps > 0 Then %>
	...
	<tr class="ewRptGrandSummary"><td colspan="26">Grand Total (<%= FormatNumber(rstotcnt,0) %> Detail Records)</td></tr>
<% End If %>
	</tfoot>
</table>
</div>
...
<form action="Asignaturas_Historicassmry.asp" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.FirstButton.Start %>"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<% Else %>
	<td><img src="rptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<% End If %>
<!--previous page button-->
	<% If Pager.PrevButton.Enabled Then %>
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.PrevButton.Start %>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<% Else %>
...
<!--next page button-->
	...
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.NextButton.Start %>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<% Else %>
	<td><img src="rptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<% End If %>
<!--last page button-->
	<% If Pager.LastButton.Enabled Then %>
	<td><a href="Asignaturas_Historicassmry.asp?start=<%= Pager.LastButton.Start %>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<% Else %>
