...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_morososFuturos Then
			ParentPage = CType(Page, AspNetReportMaker4_morososFuturos)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_morososFuturos.crLanguage(New AspNetReportMaker4_morososFuturos.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
