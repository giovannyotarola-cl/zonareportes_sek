...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 
		If TypeOf Page Is AspNetReportMaker4_dicomBajarPagare Then
			ParentPage = CType(Page, AspNetReportMaker4_dicomBajarPagare)
			If ParentPage.ReportLanguage Is Nothing Then
				ParentPage.ReportLanguage = New AspNetReportMaker4_dicomBajarPagare.crLanguage(New AspNetReportMaker4_dicomBajarPagare.AspNetReportMakerPage())
			End If
		End If
	End Sub
</script>
