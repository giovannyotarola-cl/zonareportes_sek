...
Public Partial Class AspNetReportMaker4_dicomBajarPagare
	...
	' Project
	Public Const EWRPT_PROJECT_NAME As String = "dicomBajarPagare" ' Project variable
	...
	Public Const EWRPT_RANDOM_KEY As String = "eV&9wsny3q08TONg" ' Random key for encryption

	Public Const EWRPT_PROJECT_STYLESHEET_FILENAME As String = "aspxrptcss/dicomBajarPagare.css" ' Project stylesheet file name
