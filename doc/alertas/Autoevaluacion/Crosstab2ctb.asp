...
<% End If %>
<div id="underline">
	<h1>Detalle Situaciones Acad&eacute;micas Especiales</h1>
</div>
<% If Crosstab2.Export = "" Then %>
&nbsp;&nbsp;<a href="Crosstab2ctb.asp?export=excel&acc=<%=Request("acc")%>"><img src="images/Talwayseb - Excel 2007.png" border="0" title="Exportar a Excel" /></a>
<% End If %>
<br><br>
<% If Crosstab2.Export = "" Then %>
</div></td></tr>
