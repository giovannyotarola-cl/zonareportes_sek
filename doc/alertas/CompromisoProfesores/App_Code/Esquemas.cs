...
namespace APRPAsignaturas
{
    public partial class DatosAsignatura_TYPE
    {
        ...
        private string promnotageneral;
        ...
        public string PromNotasGeneral
        {
            get { return this.promnotageneral; }
            set { this.promnotageneral = value; }
        }
	...
	public partial class DatosFacultad_TYPE
    {        
        private string codigoSede;
        private string nombreSede;
        private string codigoFacultad;
